...
Daily limit: 78% remaining`},{id:"review",command:"/review",zhName:"\u4EE3\u7801\u5BA1\u67E5",zhDescription:"\u8BA9 Claude Code \u5BA1\u67E5\u5F53\u524D\u7684\u4EE3\u7801\u6539\u52A8\uFF0C\u627E\u51FA\u6F5C\u5728\u95EE\u9898\u5E76\u7ED9\u51FA\u6539\u8FDB\u5EFA\u8BAE\u3002\u76F8\u5F53\u4E8E\u4E00\u4E2A AI code reviewer\u3002",scenario:"\u4F60\u5199\u5B8C\u4E86\u4E00\u4E2A\u65B0\u529F\u80FD\uFF0C\u60F3\u5728\u63D0\u4EA4 PR \u4E4B\u524D\u8BA9 Claude Code \u5E2E\u4F60\u68C0\u67E5\u4EE3\u7801\u8D28\u91CF\u3002\u4F60\u8BE5\u7528\u4EC0\u4E48\u547D\u4EE4\uFF1F",wrongChoices:["/check \u2014 \u8FD0\u884C\u68C0\u67E5","/lint \u2014 \u4EE3\u7801\u683C\u5F0F\u5316","/audit \u2014 \u5B89\u5168\u5BA1\u8BA1"],terminalResponse:`Reviewing staged changes...
  ...
  `}function P(e,t,n,l){let i=!1,s=e.querySelectorAll(".option-btn");s.forEach((o,a)=>{o.addEventListener("click",()=>{if(i)return;i=!0;let r=parseInt(o.dataset.index||String(a)),c=r===t;s.forEach((d,p)=>{d.classList.add("disabled"),p===t&&d.classList.add("correct"),d===o&&!c&&d.classList.add("wrong")}),C(c?"correct":"wrong"),(c?n:l)(r)})})}function de(e){let t=0,n=0;function l(){e.innerHTML=`
    ...
    `,e.querySelector("#go-back")?.addEventListener("click",()=>_.navigate("/"));return}function i(){if(n>=t.length){s();return}let o=t[n],a="",r="",c=[],d=0;if(o.type==="vocab"){let f=E.find(x=>x.id===o.id);f&&(a=`<div class="game-question">${f.en}</div><div class="game-question-sub">\u8FD9\u4E2A\u82F1\u6587\u672F\u8BED\u7684\u4E2D\u6587\u662F\u4EC0\u4E48\uFF1F</div>`,r=f.zh,c=[...E.filter(m=>m.id!==f.id).sort(()=>Math.random()-.5).slice(0,3).map(m=>m.zh),f.zh].sort(()=>Math.random()-.5),d=c.indexOf(f.zh))}else if(o.type==="command"){let f=H.find(x=>x.id===o.id);f&&(a=`<div class="game-question">${f.scenario}</div><div class="game-question-sub">\u9009\u62E9\u6B63\u786E\u7684\u547D\u4EE4</div>`,r=f.command,c=[f.command,...f.wrongChoices.slice(0,3)].sort(()=>Math.random()-.5),d=c.indexOf(f.command))}if(c.length===0){n++,i();return}e.innerHTML=`
      ${w(`\u590D\u4E60 ${n+1}/${t.length}`,!0)}
      <div class="game-screen">
  ...
  `,p.forEach((g,b)=>{setTimeout(()=>ge(g),(b+1)*800)}),c?(setTimeout(()=>ve(),500),C("perfect")):d?C("levelUp"):C("wrong"),e.querySelector("#next-level")?.addEventListener("click",()=>{let g=l+1,b=y.getWorldLevelCount(n);g<b?_.navigate(`/world/${n}`):n<4?_.navigate(`/world/${n+1}`):_.navigate("/")}),e.querySelector("#retry")?.addEventListener("click",()=>{_.navigate(`/game/${o}/${n}/${l}`)}),e.querySelector("#go-home")?.addEventListener("click",()=>_.navigate("/"))}function fe(e,t,n){let i=E.filter(c=>c.world===t);i.length<10&&(i=[...E]);let s=L(i).slice(0,10),o=0,a=0;function r(){if(o>=s.length){$(e,{worldId:t,levelIndex:n,score:a,total:10,gameType:"flash-match"});return}let c=s[o],d=o+1;e.innerHTML=`
    ...
    `;let p=e.querySelector("#flashcard"),f=e.querySelector("#action-btns");p.addEventListener("click",()=>{p.classList.contains("flipped")||(p.classList.add("flipped"),C("cardFlip"),f.style.visibility="visible")}),e.querySelector("#btn-know")?.addEventListener("click",()=>{a++,C("correct"),o++,r()}),e.querySelector("#btn-review")?.addEventListener("click",()=>{y.addToReviewQueue({id:c.id,type:"vocab"}),C("wrong"),o++,r()})}r()}function Re(e,t){let n=E.filter(i=>i.world===e);return n.length<4&&(n=[...E]),L(n).slice(0,t).map(i=>{let s=L(E.filter(r=>r.id!==i.id)).slice(0,3),o=L([i,...s]),a=o.findIndex(r=>r.id===i.id);return{question_zh:`\u300C${i.zh}\u300D\u7684\u82F1\u6587\u662F\u4EC0\u4E48\uFF1F`,question_en:`What is "${i.zh}" in English?`,options:o.map(r=>r.en),correctIndex:a,explanation:i.explanation}})}function ye(e,t,n){let s=[];s=Re(t,10);let o=0,a=0,r=null;function c(){r&&(clearInterval(r),r=null)}function d(){if(c(),o>=s.length){$(e,{worldId:t,levelIndex:n,score:a,total:s.length,gameType:"trivia"});return}let p=s[o],f=o+1,x=["A","B","C","D"];e.innerHTML=`
      ${w("\u77E5\u8BC6\u95EE\u7B54 Trivia",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
  ...
  `}function xe(e){let t=e.querySelector("[data-terminal]");if(!t)return;let n=t.querySelector("[data-terminal-output]"),l=t.querySelector("[data-terminal-input]");if(!n||!l)return;let i={};Promise.resolve().then(()=>(U(),pe)).then(a=>{a.commands&&Array.isArray(a.commands)?a.commands.forEach(r=>{i[r.command.toLowerCase()]={terminalResponse:r.terminalResponse}}):a.commands&&typeof a.commands=="object"&&(i=a.commands)}).catch(()=>{});function s(a,r){if(!n)return;let c=document.createElement("div");c.className=r?"terminal-line terminal-command":"terminal-line terminal-response",r?c.textContent=`$ ${a}`:c.innerHTML=a,n.appendChild(c),n.scrollTop=n.scrollHeight}function o(a){let r=a.trim().toLowerCase();if(s(a,!0),r==="")return;let c=Object.keys(i).find(d=>r===d.toLowerCase()||r.startsWith(d.toLowerCase()));if(c)s(i[c].terminalResponse);else if(r==="/help"||r==="help"){let d=Object.keys(i).map(p=>`  ${p}`).join("<br>");s(`\u53EF\u7528\u547D\u4EE4 / Available commands:<br>${d||"  (loading...)"}`)}else s("\u7801\u5C0F\u7801\u8BF4\uFF1A\u8FD9\u4E2A\u547D\u4EE4\u6211\u8FD8\u4E0D\u8BA4\u8BC6\u54E6\uFF01\u8BD5\u8BD5 /help\uFF1F")}l.addEventListener("keydown",a=>{if(a.key==="Enter"){let r=l.value;l.value="",o(r)}}),t.addEventListener("click",()=>{l.focus()})}function Ce(e,t,n){let i=L([...H]).slice(0,8),s=0,o=0;function a(){if(s>=i.length){$(e,{worldId:t,levelIndex:n,score:o,total:8,gameType:"charades"});return}let r=i[s],c=s+1,d=L([r.command+" \u2014 "+r.zhName,...r.wrongChoices]),p=r.command+" \u2014 "+r.zhName,f=d.indexOf(p),x=["A","B","C","D"];e.innerHTML=`
    ...
    `;let f=e.querySelector("#tray"),x=e.querySelector("#assembly"),m=e.querySelector("#submit-btn"),g=e.querySelector("#assembly-placeholder");function b(){g&&(g.style.display=p.length>0?"none":""),m.disabled=p.length===0}f.addEventListener("click",h=>{let u=h.target.closest(".prompt-block");if(!u||u.classList.contains("placed"))return;C("keystroke"),u.classList.add("placed");let v=u.dataset.word;p.push(v);let k=document.createElement("div");k.className="prompt-block",k.textContent=v,k.dataset.trayIndex=u.dataset.index,x.appendChild(k),k.addEventListener("click",()=>{C("keystroke");let z=p.indexOf(v);z!==-1&&p.splice(z,1),k.remove(),u.classList.remove("placed"),b()}),b()}),m.addEventListener("click",()=>{let h=c,u=0,v=h.length;for(let q=0;q<Math.min(p.length,v);q++)p[q]===h[q]&&u++;let z=u/v>=.8;z?(o++,C("correct")):(C("wrong"),y.addToReviewQueue({id:r.id,type:"prompt"}));let T=r.rating,M=[["\u6E05\u6670\u5EA6 Clarity",T.clarity],["\u5177\u4F53\u6027 Specificity",T.specificity],["\u4E0A\u4E0B\u6587 Context",T.context],["\u8BED\u6C14 Tone",T.tone]];e.innerHTML=`
      ...
      `,e.querySelector("#next-btn").addEventListener("click",()=>{s++,s<5?a():$(e,{worldId:t,levelIndex:n,score:o,total:5,gameType:"prompt-builder"})})})}a()}function ze(e,t,n){let i=L(W).slice(0,5),s=0,o=0;function a(){let r=i[s],c=r.badPrompt.split(/\s+/),d=r.goodPrompt.split(/\s+/),p=new Set(c.map(u=>u.toLowerCase())),f=d.filter(u=>!p.has(u.toLowerCase())),x=L(f),m=c.map(u=>({word:u,removed:!1})),g=[];e.innerHTML=`
    ...
    `;let b=e.querySelector("#editable"),h=e.querySelector("#bank");b.addEventListener("click",u=>{let v=u.target.closest(".word-token");if(!v)return;let k=v.dataset.index,z=v.dataset.bank;if(k!==void 0){let T=parseInt(k);m[T].removed=!m[T].removed,v.classList.toggle("removed",m[T].removed),C("keystroke")}else if(z!==void 0){C("keystroke");let T=v.dataset.word,M=g.findIndex(D=>D.word===T);M!==-1&&g.splice(M,1),v.remove();let q=h.querySelector(`[data-bank="${z}"]`);q&&(q.classList.remove("selected"),q.style.display="")}}),h.addEventListener("click",u=>{let v=u.target.closest(".word-token");if(!v||v.classList.contains("selected"))return;C("keystroke");let k=v.dataset.word,z=v.dataset.bank;v.classList.add("selected"),v.style.display="none",g.push({word:k,afterIndex:m.length});let T=document.createElement("span");T.className="word-token selected",T.textContent=k,T.dataset.bank=z,T.dataset.word=k,b.appendChild(T)}),e.querySelector("#submit-btn").addEventListener("click",()=>{let u=[];m.forEach(I=>{I.removed||u.push(I.word)}),g.forEach(I=>u.push(I.word));let v=u.join(" ").toLowerCase(),k=new Set(d.map(I=>I.toLowerCase())),z=new Set(u.map(I=>I.toLowerCase())),T=0;k.forEach(I=>{z.has(I)&&T++});let M=c.filter(I=>!k.has(I.toLowerCase())),q=0;M.forEach(I=>{z.has(I.toLowerCase())&&q++});let ee=Math.max(0,T/k.size-q*.1)>=.5;ee?(o++,C("correct")):(C("wrong"),y.addToReviewQueue({id:r.id,type:"prompt"})),e.innerHTML=`
        ${w("\u63D0\u793A\u8BCD\u4FEE\u590D Prompt Repair",!0)}
        <div class="game-screen">
          <div class="game-score-bar">
            <span>\u7B2C ${s+1}/5 \u9898</span>
      ...
      `,e.querySelector("#next-btn").addEventListener("click",()=>{s++,s<5?a():$(e,{worldId:t,levelIndex:n,score:o,total:5,gameType:"prompt-repair"})})})}a()}function Le(e,t,n){let i=L(W),s=[];for(;s.length<10;)s.push(...i);let o=s.slice(0,10),a=0,r=0;function c(){let d=o[a],p=Math.random()<.5,f=p?d.goodPrompt:d.badPrompt,x=p?d.badPrompt:d.goodPrompt,m=p?"left":"right";e.innerHTML=`
    ...
    `,e.querySelector("#start-btn")?.addEventListener("click",()=>{r=!1,d()})}function d(){if(o>=s.length){$(e,{worldId:t,levelIndex:n,score:a,total:3*100,gameType:"boss-battle"});return}let p=s[o],f=o+1,x=L(p.commandOptions);e.innerHTML=`
      ${w("\u9762\u8BD5\u6A21\u62DF Boss Battle",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>\u573A\u666F ${f}/3</span>
  ...
  `,e.querySelector("#start-mission")?.addEventListener("click",()=>{c()})}function X(){let e=[];for(let t of[1,2,3,4])Z[t]&&e.push(...Z[t]);return e}function He(e,t){return btoa(JSON.stringify({q:e,s:t}))}function Oe(e){try{let t=e.startsWith("#peer=")?e.slice(6):null;if(!t)return null;let n=JSON.parse(atob(t));return!Array.isArray(n.q)||typeof n.s!="number"||!isFinite(n.s)?null:{questionIds:n.q.filter(l=>typeof l=="string"),peerScore:Math.max(0,Math.floor(n.s))}}catch{return null}}function Se(e,t,n){let i=Oe(window.location.hash),s;if(i&&i.questionIds.length>0){let d=X();s=i.questionIds.map(p=>d.find(f=>f.id===p)).filter(p=>!!p),s.length===0&&(s=L(X()).slice(0,5))}else s=L(X()).slice(0,5);let o=0,a=0;function r(){if(o>=s.length){c();return}let d=s[o],p=o+1,f=["A","B","C","D"];e.innerHTML=`
