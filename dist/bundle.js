...
Daily limit: 78% remaining`},{id:"review",command:"/review",zhName:"\u4EE3\u7801\u5BA1\u67E5",zhDescription:"\u8BA9 Claude Code \u5BA1\u67E5\u5F53\u524D\u7684\u4EE3\u7801\u6539\u52A8\uFF0C\u627E\u51FA\u6F5C\u5728\u95EE\u9898\u5E76\u7ED9\u51FA\u6539\u8FDB\u5EFA\u8BAE\u3002\u76F8\u5F53\u4E8E\u4E00\u4E2A AI code reviewer\u3002",scenario:"\u4F60\u5199\u5B8C\u4E86\u4E00\u4E2A\u65B0\u529F\u80FD\uFF0C\u60F3\u5728\u63D0\u4EA4 PR \u4E4B\u524D\u8BA9 Claude Code \u5E2E\u4F60\u68C0\u67E5\u4EE3\u7801\u8D28\u91CF\u3002\u4F60\u8BE5\u7528\u4EC0\u4E48\u547D\u4EE4\uFF1F",wrongChoices:["/check \u2014 \u8FD0\u884C\u68C0\u67E5","/lint \u2014 \u4EE3\u7801\u683C\u5F0F\u5316","/audit \u2014 \u5B89\u5168\u5BA1\u8BA1"],terminalResponse:`Reviewing staged changes...
  ...
  Select a model:`}]});var Y=class{constructor(){this.routes=[];this.currentCleanup=null}addRoute(t,n){let l=[],i=t.replace(/:(\w+)/g,(s,o)=>(l.push(o),"([^/]+)"));this.routes.push({pattern:new RegExp(`^#${i}$`),paramNames:l,handler:n})}navigate(t){window.location.hash=t}start(){let t=()=>{this.currentCleanup&&(this.currentCleanup(),this.currentCleanup=null);let n=window.location.hash||"#/";for(let l of this.routes){let i=n.match(l.pattern);if(i){let s={};l.paramNames.forEach((a,r)=>{s[a]=i[r+1]}),l.handler(s);let o=document.getElementById("app");o&&(o.setAttribute("tabindex","-1"),o.focus({preventScroll:!0}));return}}n!=="#/"&&this.navigate("/")};window.addEventListener("hashchange",t),t()}setCleanup(t){this.currentCleanup=t}},_=new Y;var Q=[{id:1,zh:"\u7EC8\u7AEF\u4E4B\u95E8",en:"The Terminal Gate",icon:"\u{1F6AA}",color:"#00d4aa"},{id:2,zh:"\u547D\u4EE4\u738B\u56FD",en:"Command Kingdom",icon:"\u2694\uFE0F",color:"#ffc857"},{id:3,zh:"\u63D0\u793A\u5BAB\u6BBF",en:"Prompt Palace",icon:"\u{1F3F0}",color:"#ff6b6b"},{id:4,zh:"\u667A\u80FD\u4F53\u64C2\u53F0",en:"Agent Arena",icon:"\u{1F916}",color:"#a78bfa"}],V={1:[{title_zh:"\u57FA\u7840\u8BCD\u6C47 A",title_en:"Basic Vocab A",gameType:"flash-match",icon:"\u{1F0CF}"},{title_zh:"\u57FA\u7840\u8BCD\u6C47 B",title_en:"Basic Vocab B",gameType:"flash-match",icon:"\u{1F0CF}"},{title_zh:"\u7EC8\u7AEF\u77E5\u8BC6\u6D4B\u9A8C",title_en:"Terminal Quiz",gameType:"trivia",icon:"\u2753"},{title_zh:"\u7EFC\u5408\u6D4B\u9A8C",title_en:"Comprehensive Quiz",gameType:"trivia",icon:"\u{1F3C6}"}],2:[{title_zh:"\u547D\u4EE4\u731C\u731C\u770B A",title_en:"Command Charades A",gameType:"charades",icon:"\u{1F3AD}"},{title_zh:"\u547D\u4EE4\u731C\u731C\u770B B",title_en:"Command Charades B",gameType:"charades",icon:"\u{1F3AD}"},{title_zh:"\u5DE5\u4F5C\u6D41\u6392\u5E8F",title_en:"Workflow Builder",gameType:"drag-drop",icon:"\u{1F500}"},{title_zh:"\u8BB0\u5FC6\u914D\u5BF9 A",title_en:"Memory Match A",gameType:"memory-match",icon:"\u{1F9E0}"},{title_zh:"\u8BB0\u5FC6\u914D\u5BF9 B",title_en:"Memory Match B",gameType:"memory-match",icon:"\u{1F9E0}"},{title_zh:"\u547D\u4EE4\u5927\u5E08\u6D4B\u9A8C",title_en:"Command Master Quiz",gameType:"trivia",icon:"\u{1F451}"}],3:[{title_zh:"\u63D0\u793A\u8BCD\u7EC4\u88C5 A",title_en:"Prompt Builder A",gameType:"prompt-builder",icon:"\u{1F9E9}"},{title_zh:"\u63D0\u793A\u8BCD\u7EC4\u88C5 B",title_en:"Prompt Builder B",gameType:"prompt-builder",icon:"\u{1F9E9}"},{title_zh:"\u63D0\u793A\u8BCD\u4FEE\u590D",title_en:"Prompt Repair",gameType:"prompt-repair",icon:"\u{1F527}"},{title_zh:"\u63D0\u793A\u8BCD\u5BF9\u51B3 A",title_en:"Prompt Duel A",gameType:"prompt-duel",icon:"\u2694\uFE0F"},{title_zh:"\u63D0\u793A\u8BCD\u5BF9\u51B3 B",title_en:"Prompt Duel B",gameType:"prompt-duel",icon:"\u2694\uFE0F"},{title_zh:"\u63D0\u793A\u8BCD\u5927\u5E08",title_en:"Prompt Master",gameType:"prompt-builder",icon:"\u2728"}],4:[{title_zh:"Boss\u6311\u6218 A",title_en:"Boss Battle A",gameType:"boss-battle",icon:"\u{1F409}"},{title_zh:"Boss\u6311\u6218 B",title_en:"Boss Battle B",gameType:"boss-battle",icon:"\u{1F409}"},{title_zh:"\u6BCF\u65E5\u4EFB\u52A1",title_en:"Daily Mission",gameType:"daily-mission",icon:"\u{1F4CB}"},{title_zh:"\u597D\u53CB\u6311\u6218",title_en:"Peer Challenge",gameType:"peer-challenge",icon:"\u{1F91D}"},{title_zh:"\u7EC8\u6781Boss",title_en:"Final Boss",gameType:"boss-battle",icon:"\u{1F479}"},{title_zh:"\u6BD5\u4E1A\u8BC1\u4E66",title_en:"Certificate",gameType:"boss-battle",icon:"\u{1F393}"}]};function te(e){return V[e]?.length??0}function ne(e){let t=Q[e-1];return t?{zh:t.zh,en:t.en}:{zh:"\u672A\u77E5",en:"Unknown"}}var oe=Object.fromEntries(Q.map(e=>[e.id,e.zh]));function F(){return{1:{levelsCompleted:[],scores:{},stars:{}},2:{levelsCompleted:[],scores:{},stars:{}},3:{levelsCompleted:[],scores:{},stars:{}},4:{levelsCompleted:[],scores:{},stars:{}}}}var K={placementCompleted:!1,placementScore:0,worlds:F(),streak:{current:0,longest:0,lastLogin:""},badges:[],reviewQueue:[],totalScore:0,dailyMissionIndex:0,dailyMissionDate:""},se="cq_state",J=class{constructor(){this.state=this.load()}load(){try{let t=localStorage.getItem(se);if(t){let n=JSON.parse(t);return{...K,...n,worlds:Object.fromEntries([1,2,3,4].map(l=>[l,{...F()[l],...n.worlds?.[l]||{}}]))}}}catch(t){console.warn("Failed to load state:",t)}return{...K,worlds:F()}}save(){try{localStorage.setItem(se,JSON.stringify(this.state))}catch{}}get(){return this.state}isPlacementDone(){return this.state.placementCompleted}completePlacement(t){this.state.placementCompleted=!0,this.state.placementScore=t,t>=4&&t<=6?(this.state.worlds[1].levelsCompleted=[0,1],this.state.worlds[1].scores={0:80,1:80},this.state.worlds[1].stars={0:2,1:2}):t>=7&&(this.state.worlds[1].levelsCompleted=[0,1,2,3],this.state.worlds[1].scores={0:90,1:90,2:90,3:90},this.state.worlds[1].stars={0:3,1:3,2:3,3:3}),this.save()}isWorldUnlocked(t){if(t===1)return!0;let n=this.state.worlds[t-1];if(!n)return!1;let l=this.getWorldLevelCount(t-1);return n.levelsCompleted.length>=l}getWorldLevelCount(t){return te(t)}isLevelUnlocked(t,n){return n===0?this.isWorldUnlocked(t):this.state.worlds[t]?.levelsCompleted.includes(n-1)||!1}completeLevel(t,n,l){let i=this.state.worlds[t];if(!i)return;i.levelsCompleted.includes(n)||i.levelsCompleted.push(n);let s=i.scores[n]||0;i.scores[n]=Math.max(s,l);let o=l>=100?3:l>=70?2:l>=40?1:0,a=i.stars[n]||0;i.stars[n]=Math.max(a,o),this.state.totalScore+=Math.max(0,l-s),this.save()}updateStreak(){let t=new Date().toISOString().split("T")[0],n=this.state.streak.lastLogin;if(n===t)return;let l=new Date(Date.now()-864e5).toISOString().split("T")[0];n===l?this.state.streak.current++:this.state.streak.current=1,this.state.streak.longest=Math.max(this.state.streak.longest,this.state.streak.current),this.state.streak.lastLogin=t,this.save()}getStreak(){return this.state.streak}addBadge(t){return this.state.badges.includes(t)?!1:(this.state.badges.push(t),this.save(),!0)}hasBadge(t){return this.state.badges.includes(t)}addToReviewQueue(t){let n=this.state.reviewQueue.find(l=>l.id===t.id);n?(n.wrongCount++,n.lastSeen=Date.now()):this.state.reviewQueue.push({...t,lastSeen:Date.now(),wrongCount:1,correctCount:0}),this.save()}markReviewCorrect(t){let n=this.state.reviewQueue.find(l=>l.id===t);n&&(n.correctCount++,n.lastSeen=Date.now(),n.correctCount>=3&&(this.state.reviewQueue=this.state.reviewQueue.filter(l=>l.id!==t))),this.save()}getDueReviewItems(t=10){let n=Date.now()-2592e5;return this.state.reviewQueue.filter(l=>l.lastSeen<n||l.wrongCount>=l.correctCount).slice(0,t)}getWorldCompletion(t){let n=this.state.worlds[t];if(!n)return 0;let l=this.getWorldLevelCount(t);return Math.round(n.levelsCompleted.length/l*100)}getTotalLevelsCompleted(){return Object.values(this.state.worlds).reduce((t,n)=>t+n.levelsCompleted.length,0)}getDailyMissionIndex(){let t=new Date().toISOString().split("T")[0];return this.state.dailyMissionDate!==t&&(this.state.dailyMissionIndex=(this.state.dailyMissionIndex+1)%30,this.state.dailyMissionDate=t,this.save()),this.state.dailyMissionIndex}resetProgress(){this.state={...K,worlds:F()},this.save()}},y=new J;var ie={firstLogin:"\u6B22\u8FCE\u6765\u5230\u7801\u73A9\uFF01\u6211\u662F\u7801\u5C0F\u7801\uFF0C\u4F60\u7684AI\u7F16\u7A0B\u4F19\u4F34\u3002\u4E00\u8D77\u5B66Claude Code\u5427\uFF01",wrongAnswer:["\u6CA1\u5173\u7CFB\uFF0C\u518D\u8BD5\u4E00\u6B21\uFF01\u8FD9\u4E2A\u8BCD\u5F88\u591A\u4EBA\u90FD\u4F1A\u641E\u6DF7\u3002","\u4E0D\u8981\u7070\u5FC3\uFF0C\u9519\u8BEF\u662F\u5B66\u4E60\u7684\u4E00\u90E8\u5206\uFF01","\u5DEE\u4E00\u70B9\u70B9\uFF01\u518D\u60F3\u60F3\u770B\uFF1F"],correctAnswer:["\u592A\u68D2\u4E86\uFF01\u4F60\u8D8A\u6765\u8D8A\u5389\u5BB3\u4E86\uFF01","\u7B54\u5BF9\u4E86\uFF01\u7EE7\u7EED\u4FDD\u6301\uFF01","\u6CA1\u9519\uFF01\u4F60\u5BF9Claude Code\u8D8A\u6765\u8D8A\u719F\u4E86\uFF01"],streak7:"\u8FDE\u7EED7\u5929\u4E86\uFF01\u575A\u6301\u5C31\u662F\u529B\u91CF\uFF0C\u7EE7\u7EED\u52A0\u6CB9\uFF01",streak21:"21\u5929\uFF01\u4F60\u5DF2\u7ECF\u517B\u6210\u4E86\u5B66\u4E60\u4E60\u60EF\uFF0C\u592A\u4E86\u4E0D\u8D77\u4E86\uFF01",worldComplete:["\u7EC8\u7AEF\u4E4B\u95E8\u6253\u901A\u4E86\uFF01\u547D\u4EE4\u738B\u56FD\u5728\u524D\u65B9\u7B49\u4F60\u3002","\u547D\u4EE4\u738B\u56FD\u5DF2\u62FF\u4E0B\uFF01\u63A5\u4E0B\u6765\u53BB\u63D0\u793A\u5BAB\u6BBF\u3002","\u63D0\u793A\u5BAB\u6BBF\u901A\u5173\uFF01\u51C6\u5907\u597D\u8FCE\u63A5\u6700\u540E\u7684\u6311\u6218\u4E86\u5417\uFF1F","\u5168\u90E8\u901A\u5173\uFF01\u4F60\u5DF2\u7ECF\u638C\u63E1\u4E86Claude Code\u7684\u6838\u5FC3\u6280\u80FD\uFF01"],perfectScore:"\u5168\u5BF9\uFF01\u8FD9\u9053\u9898\u96BE\u4E0D\u5012\u4F60\uFF01\u{1F389}",retry:"\u5931\u8D25\u662F\u6210\u529F\u4E4B\u6BCD\u3002\u6362\u4E2A\u601D\u8DEF\u518D\u6765\u4E00\u6B21\uFF01",bossStart:"\u6DF1\u547C\u5438\u3002\u4F60\u5DF2\u7ECF\u5B66\u4E86\u8FD9\u4E48\u591A\uFF0C\u9762\u8BD5\u5B98\u624D\u8BE5\u7D27\u5F20\u3002",certificate:"\u6BD5\u4E1A\u4E86\uFF01\u5E26\u7740\u8FD9\u4E9B\u6280\u80FD\u53BB\u5199\u4EE3\u7801\u5427\uFF01"};function S(e,t){let n="",l=t||"neutral",i=ie[e];return i&&(typeof i=="string"?n=i:Array.isArray(i)&&(n=i[Math.floor(Math.random()*i.length)])),n||(n="\u4F60\u597D\uFF01\u6211\u662F\u7801\u5C0F\u7801\uFF0C\u4F60\u7684\u7F16\u7A0B\u5C0F\u4F19\u4F34\uFF01"),`
    <div class="mascot-container" role="region" aria-label="\u7801\u5C0F\u7801">
      ...
      <div class="mascot-bubble" role="status">${n}</div>
    </div>
  `}function re(e){let t=y.getStreak(),n=y.getDueReviewItems().length,l="firstLogin";t.current>=21?l="streak21":t.current>=7?l="streak7":y.getTotalLevelsCompleted()>0&&(l="correctAnswer"),e.innerHTML=`
    <div class="screen" style="padding-top:var(--space-lg);">
      ...
      <div style="display:flex;flex-direction:column;gap:var(--space-md);margin-top:var(--space-lg);position:relative;">
        ...
        ${Q.map(i=>{let s=y.isWorldUnlocked(i.id),o=y.getWorldCompletion(i.id),a=s&&o<100;return`
            <div class="card ${s?"":"locked"} ${a?"card-highlight":""}" data-world="${i.id}"
                 role="${s?"button":"presentation"}" tabindex="${s?"0":"-1"}"
                 aria-label="${i.zh} ${i.en}${s?` ${o}%`:" \u5DF2\u9501\u5B9A"}"
                 style="display:flex;align-items:center;gap:var(--space-md);position:relative;z-index:1;${s?"":"opacity:0.4;"}cursor:${s?"pointer":"default"};">
              <div style="width:56px;height:56px;border-radius:var(--radius-full);background:${s?i.color:"var(--bg-secondary)"};display:flex;align-items:center;justify-content:center;font-size:var(--text-2xl);flex-shrink:0;">
                ${s?i.icon:"\u{1F512}"}
              </div>
              <div style="flex:1;">
                ...
                ${s?`
                  ...
                  <div style="font-size:var(--text-xs);color:var(--text-muted);margin-top:2px;">${o}% \u5B8C\u6210</div>
  ...
  `,e.querySelectorAll("[data-world]").forEach(i=>{let s=()=>{let o=i.getAttribute("data-world");o&&y.isWorldUnlocked(parseInt(o))&&_.navigate(`/world/${o}`)};i.addEventListener("click",s),i.addEventListener("keydown",o=>{o.key==="Enter"&&s()})}),e.querySelector("#btn-glossary")?.addEventListener("click",()=>_.navigate("/glossary")),e.querySelector("#btn-profile")?.addEventListener("click",()=>_.navigate("/profile")),e.querySelector("#btn-review")?.addEventListener("click",()=>_.navigate("/review"))}function w(e,t,n){let l=y.getStreak();return`
    <div class="header">
  ...
  `}function le(e,t){let n=ne(t),l=V[t]||[],i=y.getWorldCompletion(t),s=y.get().worlds[t];e.innerHTML=`
    ${w(`${n.zh} ${n.en}`,!0)}
    <div class="screen">
      ${ae(i)}
      ...
      <div style="display:flex;flex-direction:column;gap:var(--space-sm);">
        ${l.map((o,a)=>{let r=y.isLevelUnlocked(t,a),c=s?.levelsCompleted.includes(a),d=s?.stars[a]||0;return`
            <div class="card" data-level="${a}" role="${r?"button":"presentation"}" tabindex="${r?"0":"-1"}"
                 aria-label="${o.title_zh} ${o.title_en}${r?` ${d}\u661F`:" \u5DF2\u9501\u5B9A"}"
                 style="${r?"cursor:pointer;":"opacity:0.4;pointer-events:none;"}">
              <div style="display:flex;align-items:center;gap:var(--space-md);">
                ...
                <div style="flex:1;">
                  <div style="font-weight:600;font-size:var(--text-base);">${o.title_zh}</div>
                  <div style="font-size:var(--text-xs);color:var(--text-secondary);">${o.title_en}</div>
                </div>
                <div class="stars">
                  ${[1,2,3].map(p=>`<span class="star ${p<=d?"earned":""}">\u2605</span>`).join("")}
                </div>
              </div>
            </div>
          `}).join("")}
  ...
  `}function P(e,t,n,l){let i=!1,s=e.querySelectorAll(".option-btn");s.forEach((o,a)=>{o.addEventListener("click",()=>{if(i)return;i=!0;let r=parseInt(o.dataset.index||String(a)),c=r===t;s.forEach((d,p)=>{d.classList.add("disabled"),p===t&&d.classList.add("correct"),d===o&&!c&&d.classList.add("wrong")}),C(c?"correct":"wrong"),(c?n:l)(r)})})}function de(e){let t=0,n=0;function l(){e.innerHTML=`
    ...
    `,e.querySelector("#start-placement")?.addEventListener("click",()=>i()),e.querySelector("#skip-placement")?.addEventListener("click",()=>{y.completePlacement(0),y.updateStreak(),_.navigate("/")})}function i(){if(t>=B.length){s();return}let o=B[t];e.innerHTML=`
      ${w(`${t+1} / ${B.length}`,!1)}
      <div class="game-screen">
        <div class="progress-bar" style="margin-top:var(--space-md);">
          <div class="progress-bar-fill" style="width:${t/B.length*100}%"></div>
        </div>
        <div class="game-question">${o.question_zh}</div>
        <div class="game-question-sub">${o.question_en}</div>
    ...
    `,e.querySelector("#go-home")?.addEventListener("click",()=>_.navigate("/")),n>=7?C("perfect"):C("levelUp")}l()}var E=[{id:"terminal",en:"Terminal",pinyin:"zh\u014Dng du\u0101n",zh:"\u7EC8\u7AEF",explanation:"\u7EC8\u7AEF\u662F\u4F60\u4E0E\u7535\u8111\u5BF9\u8BDD\u7684\u6587\u5B57\u754C\u9762\u3002Claude Code \u5C31\u8FD0\u884C\u5728\u7EC8\u7AEF\u91CC\uFF0C\u4F60\u5728\u8FD9\u91CC\u8F93\u5165\u6307\u4EE4\uFF0C\u5B83\u5C31\u4F1A\u5E2E\u4F60\u5199\u4EE3\u7801\u3002",world:1},{id:"cli",en:"CLI",pinyin:"m\xECng l\xECng h\xE1ng ji\xE8 mi\xE0n",zh:"\u547D\u4EE4\u884C\u754C\u9762",explanation:"CLI\uFF08Command Line Interface\uFF09\u662F\u901A\u8FC7\u8F93\u5165\u6587\u5B57\u547D\u4EE4\u6765\u64CD\u4F5C\u7535\u8111\u7684\u65B9\u5F0F\u3002Claude Code \u662F\u4E00\u4E2A CLI \u5DE5\u5177\uFF0C\u4E0D\u9700\u8981\u56FE\u5F62\u754C\u9762\u3002",world:1},{id:"directory",en:"Directory",pinyin:"m\xF9 l\xF9",zh:"\u76EE\u5F55",explanation:"\u76EE\u5F55\u5C31\u662F\u6587\u4EF6\u5939\u3002\u5728\u7EC8\u7AEF\u91CC\u7528 cd \u547D\u4EE4\u5207\u6362\u76EE\u5F55\u3002Claude Code \u4F1A\u8BFB\u53D6\u5F53\u524D\u76EE\u5F55\u4E0B\u7684\u6240\u6709\u6587\u4EF6\u6765\u7406\u89E3\u4F60\u7684\u9879\u76EE\u3002",world:1},{id:"repository",en:"Repository",pinyin:"c\u0101ng k\xF9",zh:"\u4ED3\u5E93",explanation:"\u4ED3\u5E93\uFF08repo\uFF09\u662F\u7528 Git \u7BA1\u7406\u7684\u9879\u76EE\u6587\u4EF6\u5939\u3002Claude Code \u542F\u52A8\u65F6\u4F1A\u81EA\u52A8\u8BFB\u53D6\u4ED3\u5E93\u7684 Git \u5386\u53F2\u6765\u7406\u89E3\u9879\u76EE\u80CC\u666F\u3002",world:1},{id:"codebase",en:"Codebase",pinyin:"d\xE0i m\u01CE k\xF9",zh:"\u4EE3\u7801\u5E93",explanation:"\u4EE3\u7801\u5E93\u662F\u4E00\u4E2A\u9879\u76EE\u7684\u5168\u90E8\u6E90\u4EE3\u7801\u3002Claude Code \u53EF\u4EE5\u4E00\u6B21\u6027\u7406\u89E3\u6574\u4E2A\u4EE3\u7801\u5E93\uFF0C\u5E2E\u4F60\u627E bug\u3001\u91CD\u6784\u6216\u6DFB\u52A0\u529F\u80FD\u3002",world:1},{id:"readme",en:"README",pinyin:"shu\u014D m\xEDng w\xE9n ji\xE0n",zh:"\u8BF4\u660E\u6587\u4EF6",explanation:"README \u662F\u9879\u76EE\u7684\u8BF4\u660E\u4E66\uFF0C\u901A\u5E38\u7528 Markdown \u5199\u6210\u3002\u5B83\u544A\u8BC9\u522B\u4EBA\u8FD9\u4E2A\u9879\u76EE\u662F\u4EC0\u4E48\u3001\u600E\u4E48\u5B89\u88C5\u3001\u600E\u4E48\u4F7F\u7528\u3002",world:1},{id:"claude-md",en:"CLAUDE.md",pinyin:"Claude p\xE8i zh\xEC w\xE9n ji\xE0n",zh:"Claude \u914D\u7F6E\u6587\u4EF6",explanation:"CLAUDE.md \u662F Claude Code \u7684\u4E13\u5C5E\u6307\u4EE4\u6587\u4EF6\u3002\u4F60\u53EF\u4EE5\u5728\u91CC\u9762\u5199\u9879\u76EE\u89C4\u8303\u3001\u7F16\u7801\u98CE\u683C\u3001\u90E8\u7F72\u89C4\u5219\uFF0CClaude Code \u6BCF\u6B21\u542F\u52A8\u90FD\u4F1A\u81EA\u52A8\u8BFB\u53D6\u3002",world:1},{id:"environment",en:"Environment",pinyin:"hu\xE1n j\xECng",zh:"\u73AF\u5883",explanation:"\u73AF\u5883\u662F\u4EE3\u7801\u8FD0\u884C\u7684\u914D\u7F6E\u548C\u6761\u4EF6\uFF0C\u6BD4\u5982\u5F00\u53D1\u73AF\u5883\u3001\u751F\u4EA7\u73AF\u5883\u3002Claude Code \u80FD\u5E2E\u4F60\u7BA1\u7406\u73AF\u5883\u53D8\u91CF\u548C\u914D\u7F6E\u6587\u4EF6\u3002",world:1},{id:"prompt",en:"Prompt",pinyin:"t\xED sh\xEC c\xED",zh:"\u63D0\u793A\u8BCD",explanation:"\u63D0\u793A\u8BCD\u662F\u4F60\u7ED9 Claude Code \u7684\u6307\u4EE4\u3002\u597D\u7684\u63D0\u793A\u8BCD\u8981\u5177\u4F53\u3001\u6709\u4E0A\u4E0B\u6587\uFF0C\u6BD4\u5982\u300C\u91CD\u6784\u8FD9\u4E2A\u51FD\u6570\uFF0C\u7528 async/await \u66FF\u6362\u56DE\u8C03\u300D\u3002",world:2},{id:"scaffold",en:"Scaffold",pinyin:"ji\u01CEo sh\u01D2u ji\xE0",zh:"\u811A\u624B\u67B6",explanation:"\u811A\u624B\u67B6\u662F\u81EA\u52A8\u751F\u6210\u9879\u76EE\u57FA\u7840\u7ED3\u6784\u7684\u5DE5\u5177\u3002\u4F60\u53EF\u4EE5\u8BA9 Claude Code \u5E2E\u4F60\u642D\u5EFA\u9879\u76EE\u811A\u624B\u67B6\uFF0C\u4E00\u53E5\u8BDD\u5C31\u80FD\u521B\u5EFA\u6574\u4E2A\u9879\u76EE\u6A21\u677F\u3002",world:2},{id:"diff",en:"Diff",pinyin:"ch\u0101 y\xEC",zh:"\u5DEE\u5F02",explanation:"Diff \u663E\u793A\u6587\u4EF6\u4FEE\u6539\u524D\u540E\u7684\u533A\u522B\u3002Claude Code \u6BCF\u6B21\u7F16\u8F91\u6587\u4EF6\u540E\u4F1A\u5C55\u793A diff\uFF0C\u8BA9\u4F60\u6E05\u695A\u770B\u5230\u54EA\u4E9B\u884C\u88AB\u6539\u4E86\u3002",world:2},{id:"linting",en:"Linting",pinyin:"d\xE0i m\u01CE ji\u01CEn ch\xE1",zh:"\u4EE3\u7801\u68C0\u67E5",explanation:"Linting \u662F\u81EA\u52A8\u68C0\u67E5\u4EE3\u7801\u98CE\u683C\u548C\u6F5C\u5728\u9519\u8BEF\u7684\u8FC7\u7A0B\u3002Claude Code \u53EF\u4EE5\u5E2E\u4F60\u4FEE\u590D lint \u62A5\u544A\u7684\u6240\u6709\u95EE\u9898\u3002",world:2},{id:"debugging",en:"Debugging",pinyin:"ti\xE1o sh\xEC",zh:"\u8C03\u8BD5",explanation:"\u8C03\u8BD5\u662F\u627E\u51FA\u5E76\u4FEE\u590D\u4EE3\u7801\u9519\u8BEF\u7684\u8FC7\u7A0B\u3002\u4F60\u53EF\u4EE5\u628A\u62A5\u9519\u4FE1\u606F\u76F4\u63A5\u7C98\u8D34\u7ED9 Claude Code\uFF0C\u5B83\u4F1A\u5206\u6790\u9519\u8BEF\u539F\u56E0\u5E76\u63D0\u4F9B\u4FEE\u590D\u65B9\u6848\u3002",world:2},{id:"hook",en:"Hook",pinyin:"g\u014Du zi",zh:"\u94A9\u5B50",explanation:"\u94A9\u5B50\u662F\u5728\u7279\u5B9A\u4E8B\u4EF6\u53D1\u751F\u65F6\u81EA\u52A8\u6267\u884C\u7684\u811A\u672C\u3002Claude Code \u652F\u6301 pre-commit hook\uFF0C\u5728\u4F60\u63D0\u4EA4\u4EE3\u7801\u524D\u81EA\u52A8\u8FD0\u884C\u68C0\u67E5\u3002",world:2},{id:"pipeline",en:"Pipeline",pinyin:"li\xFA shu\u01D0 xi\xE0n",zh:"\u6D41\u6C34\u7EBF",explanation:"\u6D41\u6C34\u7EBF\u662F\u4E00\u7CFB\u5217\u81EA\u52A8\u5316\u6B65\u9AA4\uFF0C\u5982\u6D4B\u8BD5\u3001\u6784\u5EFA\u3001\u90E8\u7F72\u3002Claude Code \u53EF\u4EE5\u5E2E\u4F60\u914D\u7F6E CI/CD \u6D41\u6C34\u7EBF\u3002",world:2},{id:"dependency",en:"Dependency",pinyin:"y\u012B l\xE0i",zh:"\u4F9D\u8D56",explanation:"\u4F9D\u8D56\u662F\u4F60\u7684\u9879\u76EE\u9700\u8981\u7528\u5230\u7684\u5916\u90E8\u5E93\u6216\u5305\u3002Claude Code \u80FD\u5E2E\u4F60\u7BA1\u7406 package.json \u91CC\u7684\u4F9D\u8D56\uFF0C\u89E3\u51B3\u7248\u672C\u51B2\u7A81\u3002",world:2},{id:"agentic",en:"Agentic",pinyin:"zh\xEC n\xE9ng t\u01D0",zh:"\u667A\u80FD\u4F53",explanation:"Agentic \u6307 AI \u80FD\u81EA\u4E3B\u51B3\u7B56\u548C\u884C\u52A8\u3002Claude Code \u662F agentic \u7684\u2014\u2014\u5B83\u4E0D\u53EA\u56DE\u7B54\u95EE\u9898\uFF0C\u8FD8\u80FD\u4E3B\u52A8\u8BFB\u6587\u4EF6\u3001\u5199\u4EE3\u7801\u3001\u8FD0\u884C\u547D\u4EE4\u3002",world:3},{id:"context-window",en:"Context Window",pinyin:"sh\xE0ng xi\xE0 w\xE9n chu\u0101ng k\u01D2u",zh:"\u4E0A\u4E0B\u6587\u7A97\u53E3",explanation:"\u4E0A\u4E0B\u6587\u7A97\u53E3\u662F AI \u4E00\u6B21\u80FD\u5904\u7406\u7684\u4FE1\u606F\u91CF\u3002Claude Code \u7684\u4E0A\u4E0B\u6587\u7A97\u53E3\u5F88\u5927\uFF0C\u80FD\u540C\u65F6\u7406\u89E3\u6574\u4E2A\u9879\u76EE\u7684\u4EE3\u7801\u3002\u7528 /compact \u53EF\u4EE5\u538B\u7F29\u5BF9\u8BDD\u8282\u7701\u7A7A\u95F4\u3002",world:3},{id:"compaction",en:"Compaction",pinyin:"y\u0101 su\u014D",zh:"\u538B\u7F29",explanation:"\u538B\u7F29\u662F\u628A\u957F\u5BF9\u8BDD\u7CBE\u7B80\u6210\u5173\u952E\u4FE1\u606F\u7684\u8FC7\u7A0B\u3002\u5F53 Claude Code \u7684\u4E0A\u4E0B\u6587\u5FEB\u6EE1\u65F6\uFF0C\u7528 /compact \u547D\u4EE4\u53EF\u4EE5\u81EA\u52A8\u538B\u7F29\uFF0C\u4FDD\u7559\u91CD\u8981\u5185\u5BB9\u3002",world:3},{id:"model",en:"Model",pinyin:"m\xF3 x\xEDng",zh:"\u6A21\u578B",explanation:"\u6A21\u578B\u662F\u8BAD\u7EC3\u597D\u7684 AI \u7A0B\u5E8F\u3002Claude Code \u9ED8\u8BA4\u4F7F\u7528 Claude Sonnet\uFF0C\u4F60\u53EF\u4EE5\u7528 /model \u5207\u6362\u5230\u66F4\u5F3A\u7684 Opus \u6216\u66F4\u5FEB\u7684 Haiku\u3002",world:3},{id:"token",en:"Token",pinyin:"l\xECng p\xE1i",zh:"\u4EE4\u724C",explanation:"\u4EE4\u724C\u662F AI \u5904\u7406\u6587\u5B57\u7684\u57FA\u672C\u5355\u4F4D\uFF0C\u5927\u7EA6 3/4 \u4E2A\u82F1\u6587\u5355\u8BCD\u3002Claude Code \u6309 token \u6570\u8BA1\u8D39\uFF0C\u7528 /usage \u53EF\u4EE5\u67E5\u770B\u6D88\u8017\u4E86\u591A\u5C11\u3002",world:3},{id:"api",en:"API",pinyin:"ji\u0113 k\u01D2u",zh:"\u63A5\u53E3",explanation:"API\uFF08Application Programming Interface\uFF09\u662F\u7A0B\u5E8F\u4E4B\u95F4\u901A\u4FE1\u7684\u6865\u6881\u3002Claude Code \u901A\u8FC7 Anthropic API \u4E0E Claude \u6A21\u578B\u901A\u4FE1\u3002",world:3},{id:"sub-agent",en:"Sub-agent",pinyin:"z\u01D0 zh\xEC n\xE9ng t\u01D0",zh:"\u5B50\u667A\u80FD\u4F53",explanation:"\u5B50\u667A\u80FD\u4F53\u662F Claude Code \u6D3E\u51FA\u7684\u5C0F\u52A9\u624B\uFF0C\u8D1F\u8D23\u72EC\u7ACB\u5B8C\u6210\u5B50\u4EFB\u52A1\u3002\u6BD4\u5982\u5728\u5904\u7406\u590D\u6742\u91CD\u6784\u65F6\uFF0C\u4E3B\u667A\u80FD\u4F53\u4F1A\u6D3E\u5B50\u667A\u80FD\u4F53\u53BB\u5206\u6790\u4E0D\u540C\u6587\u4EF6\u3002",world:3},{id:"version-control",en:"Version Control",pinyin:"b\u01CEn b\u011Bn k\xF2ng zh\xEC",zh:"\u7248\u672C\u63A7\u5236",explanation:"\u7248\u672C\u63A7\u5236\u8BB0\u5F55\u4EE3\u7801\u7684\u6BCF\u4E00\u6B21\u4FEE\u6539\u5386\u53F2\u3002Claude Code \u80FD\u5E2E\u4F60\u5199 commit message\u3001\u521B\u5EFA\u5206\u652F\u3001\u63D0\u4EA4 PR\uFF0C\u5168\u90E8\u5728\u7EC8\u7AEF\u91CC\u5B8C\u6210\u3002",world:4},{id:"branch",en:"Branch",pinyin:"f\u0113n zh\u012B",zh:"\u5206\u652F",explanation:"\u5206\u652F\u8BA9\u4F60\u5728\u4E0D\u5F71\u54CD\u4E3B\u4EE3\u7801\u7684\u60C5\u51B5\u4E0B\u5F00\u53D1\u65B0\u529F\u80FD\u3002Claude Code \u53EF\u4EE5\u5E2E\u4F60\u521B\u5EFA\u5206\u652F\u3001\u5207\u6362\u5206\u652F\uFF0C\u7BA1\u7406\u591A\u6761\u5F00\u53D1\u7EBF\u3002",world:4},{id:"merge",en:"Merge",pinyin:"h\xE9 b\xECng",zh:"\u5408\u5E76",explanation:"\u5408\u5E76\u662F\u628A\u4E00\u4E2A\u5206\u652F\u7684\u4EE3\u7801\u6574\u5408\u5230\u53E6\u4E00\u4E2A\u5206\u652F\u3002\u51FA\u73B0\u51B2\u7A81\u65F6\uFF0CClaude Code \u80FD\u5E2E\u4F60\u7406\u89E3\u51B2\u7A81\u5E76\u9009\u62E9\u6B63\u786E\u7684\u5408\u5E76\u65B9\u5F0F\u3002",world:4},{id:"pull-request",en:"Pull Request",pinyin:"l\u0101 q\u01D4 q\u01D0ng qi\xFA",zh:"\u62C9\u53D6\u8BF7\u6C42",explanation:"Pull Request\uFF08PR\uFF09\u662F\u8BF7\u6C42\u628A\u4F60\u7684\u4EE3\u7801\u5408\u5E76\u5230\u4E3B\u5206\u652F\u7684\u6D41\u7A0B\u3002Claude Code \u53EF\u4EE5\u7528 gh \u547D\u4EE4\u5E2E\u4F60\u521B\u5EFA PR\u3001\u5199\u63CF\u8FF0\u3001\u751A\u81F3 review \u4EE3\u7801\u3002",world:4},{id:"commit",en:"Commit",pinyin:"t\xED ji\u0101o",zh:"\u63D0\u4EA4",explanation:"\u63D0\u4EA4\u662F\u4FDD\u5B58\u4E00\u6B21\u4EE3\u7801\u4FEE\u6539\u7684\u5FEB\u7167\u3002Claude Code \u80FD\u5E2E\u4F60\u5199\u6E05\u6670\u7684 commit message\uFF0C\u9075\u5FAA Conventional Commits \u89C4\u8303\u3002",world:4},{id:"refactoring",en:"Refactoring",pinyin:"ch\xF3ng g\xF2u",zh:"\u91CD\u6784",explanation:"\u91CD\u6784\u662F\u5728\u4E0D\u6539\u53D8\u529F\u80FD\u7684\u524D\u63D0\u4E0B\u6539\u5584\u4EE3\u7801\u7ED3\u6784\u3002Claude Code \u64C5\u957F\u5927\u89C4\u6A21\u91CD\u6784\u2014\u2014\u544A\u8BC9\u5B83\u76EE\u6807\uFF0C\u5B83\u4F1A\u5B89\u5168\u5730\u4FEE\u6539\u6240\u6709\u76F8\u5173\u6587\u4EF6\u3002",world:4},{id:"deployment",en:"Deployment",pinyin:"b\xF9 sh\u01D4",zh:"\u90E8\u7F72",explanation:"\u90E8\u7F72\u662F\u628A\u4EE3\u7801\u53D1\u5E03\u5230\u670D\u52A1\u5668\u8BA9\u7528\u6237\u4F7F\u7528\u7684\u8FC7\u7A0B\u3002Claude Code \u53EF\u4EE5\u5E2E\u4F60\u914D\u7F6E Cloudflare Pages \u90E8\u7F72\uFF0C\u4E00\u884C\u547D\u4EE4\u4E0A\u7EBF\u3002",world:4}];function ce(e){let t="";function n(){let l=E.filter(s=>{if(!t)return!0;let o=t.toLowerCase();return s.en.toLowerCase().includes(o)||s.pinyin.toLowerCase().includes(o)||s.zh.includes(o)||s.explanation.includes(o)});e.innerHTML=`
      ...
      <div class="screen">
        ...
        <div style="display:flex;flex-direction:column;gap:var(--space-sm);margin-top:var(--space-sm);">
          ...
          ${l.map(s=>{let o=y.isWorldUnlocked(s.world);return`
              <div class="card" style="${o?"":"opacity:0.5;"}">
                <div style="display:flex;justify-content:space-between;align-items:flex-start;">
                  <div style="font-weight:700;color:var(--teal);font-size:var(--text-lg);">${o?s.en:"???"}</div>
    ...
    `,e.querySelector("#go-back")?.addEventListener("click",()=>_.navigate("/"));return}function i(){if(n>=t.length){s();return}let o=t[n],a="",r="",c=[],d=0;if(o.type==="vocab"){let f=E.find(x=>x.id===o.id);if(f){a=`<div class="game-question">${f.en}</div><div class="game-question-sub">\u8FD9\u4E2A\u82F1\u6587\u672F\u8BED\u7684\u4E2D\u6587\u662F\u4EC0\u4E48\uFF1F</div>`,r=f.zh;let x=z(E.filter(m=>m.id!==f.id)).slice(0,3).map(m=>m.zh);c=z([...x,f.zh]),d=c.indexOf(f.zh)}}else if(o.type==="command"){let f=H.find(x=>x.id===o.id);f&&(a=`<div class="game-question">${f.scenario}</div><div class="game-question-sub">\u9009\u62E9\u6B63\u786E\u7684\u547D\u4EE4</div>`,r=f.command,c=z([f.command,...f.wrongChoices.slice(0,3)]),d=c.indexOf(f.command))}if(c.length===0){n++,i();return}e.innerHTML=`
      ${w(`\u590D\u4E60 ${n+1}/${t.length}`,!0)}
      <div class="game-screen">
    ...
    `;let p=()=>{let f=e.querySelector("#next-btn");f&&(f.style.display="block")};P(e,d,()=>{l++,y.markReviewCorrect(o.id),p()},()=>{p()}),e.querySelector("#next-btn")?.addEventListener("click",()=>{n++,i()})}function s(){let o=Math.round(l/t.length*100);e.innerHTML=`
      ${w("\u590D\u4E60\u5B8C\u6210",!1)}
      <div class="screen" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-lg);padding-top:calc(var(--header-height) + var(--space-xl));">
        ${S(o>=80?"correctAnswer":"retry")}
        <div style="text-align:center;">
          <div style="font-size:var(--text-4xl);font-weight:700;color:var(--teal);">${o}%</div>
          <p style="color:var(--text-secondary);">${l}/${t.length} \u6B63\u786E</p>
        </div>
        <button class="btn btn-primary btn-block" id="go-home">\u8FD4\u56DE\u9996\u9875 Home</button>
      </div>
    `,e.querySelector("#go-home")?.addEventListener("click",()=>_.navigate("/")),C("levelUp")}i()}function ue(e,t){let n=t?"unlocked":"locked",l=t?e.idiom:"???",i=t?e.pinyin:"";return`
  ...
  `,t.appendChild(n),setTimeout(()=>{n.style.opacity="0",n.style.transition="opacity 0.3s",setTimeout(()=>n.remove(),300)},3e3)}var j=[{id:"first-step",idiom:"\u5343\u91CC\u4E4B\u884C\u59CB\u4E8E\u8DB3\u4E0B",pinyin:"qi\u0101n l\u01D0 zh\u012B x\xEDng sh\u01D0 y\xFA z\xFA xi\xE0",enName:"First Step",meaning:"A journey of a thousand miles begins with a single step",unlockCondition:"Complete first level",icon:"\u{1F680}"},{id:"quick-learner",idiom:"\u4E00\u70B9\u5373\u901A",pinyin:"y\u012B di\u01CEn j\xED t\u014Dng",enName:"Quick Learner",meaning:"Understanding at the first hint",unlockCondition:"Perfect score first try",icon:"\u26A1"},{id:"persistent",idiom:"\u94C1\u6775\u78E8\u6210\u9488",pinyin:"ti\u011B ch\u01D4 m\xF3 ch\xE9ng zh\u0113n",enName:"Persistent",meaning:"An iron rod can be ground into a needle with persistence",unlockCondition:"Retry and pass failed level",icon:"\u{1F528}"},{id:"practice-master",idiom:"\u719F\u80FD\u751F\u5DE7",pinyin:"sh\xFA n\xE9ng sh\u0113ng qi\u01CEo",enName:"Practice Master",meaning:"Practice makes perfect",unlockCondition:"7-day streak",icon:"\u{1F525}"},{id:"word-collector",idiom:"\u535A\u5B66\u591A\u624D",pinyin:"b\xF3 xu\xE9 du\u014D c\xE1i",enName:"Word Collector",meaning:"Learned and talented",unlockCondition:"Learn all vocab",icon:"\u{1F4DA}"},{id:"command-king",idiom:"\u8FD0\u7B79\u5E37\u5E44",pinyin:"y\xF9n ch\xF3u w\xE9i w\xF2",enName:"Command King",meaning:"Strategize from within the command tent",unlockCondition:"Complete World 2",icon:"\u{1F451}"},{id:"prompt-sage",idiom:"\u5999\u7B14\u751F\u82B1",pinyin:"mi\xE0o b\u01D0 sh\u0113ng hu\u0101",enName:"Prompt Sage",meaning:"A masterful pen produces flowers",unlockCondition:"Score 5/5 on Prompt Builder",icon:"\u2728"},{id:"interview-ready",idiom:"\u80F8\u6709\u6210\u7AF9",pinyin:"xi\u014Dng y\u01D2u ch\xE9ng zh\xFA",enName:"Interview Ready",meaning:"Having a well-thought-out plan in mind",unlockCondition:"Complete Boss Battle",icon:"\u{1F3AF}"},{id:"unstoppable",idiom:"\u52BF\u5982\u7834\u7AF9",pinyin:"sh\xEC r\xFA p\xF2 zh\xFA",enName:"Unstoppable",meaning:"Like splitting bamboo \u2014 unstoppable momentum",unlockCondition:"21-day streak",icon:"\u{1F48E}"},{id:"completionist",idiom:"\u529F\u5FB7\u5706\u6EE1",pinyin:"g\u014Dng d\xE9 yu\xE1n m\u01CEn",enName:"Completionist",meaning:"All merits fulfilled, mission complete",unlockCondition:"Finish all 4 worlds",icon:"\u{1F3C6}"},{id:"speed-demon",idiom:"\u4E00\u76EE\u5341\u884C",pinyin:"y\u012B m\xF9 sh\xED h\xE1ng",enName:"Speed Demon",meaning:"Reading ten lines at a glance",unlockCondition:"Timed quiz >50% time remaining",icon:"\u23F1\uFE0F"},{id:"sharing-caring",idiom:"\u6559\u5B66\u76F8\u957F",pinyin:"ji\xE0o xu\xE9 xi\u0101ng zh\u01CEng",enName:"Sharing is Caring",meaning:"Teaching and learning promote each other",unlockCondition:"Send Peer Challenge",icon:"\u{1F91D}"}];function he(e){let t=y.get(),n=y.getStreak(),l=y.getTotalLevelsCompleted(),i=t.reviewQueue.length>0?Math.round(t.reviewQueue.reduce((s,o)=>s+o.correctCount,0)/Math.max(1,t.reviewQueue.reduce((s,o)=>s+o.correctCount+o.wrongCount,0))*100):100;e.innerHTML=`
    ...
    <div class="screen">
      ...
      <div style="display:flex;flex-direction:column;gap:var(--space-sm);margin-bottom:var(--space-lg);">
        ${[1,2,3,4].map(s=>{let o=y.getWorldCompletion(s);return`
            <div>
              <div style="display:flex;justify-content:space-between;font-size:var(--text-sm);margin-bottom:var(--space-xs);">
                <span>${oe[s]}</span><span style="color:var(--text-secondary);">${o}%</span>
              </div>
              <div class="progress-bar"><div class="progress-bar-fill" style="width:${o}%"></div></div>
            </div>
          `}).join("")}
      </div>
      ...
      <div style="display:grid;grid-template-columns:repeat(3, 1fr);gap:var(--space-sm);">
        ${j.map(s=>ue(s,t.badges.includes(s.id))).join("")}
      </div>
    </div>
  ...
  `,!document.getElementById("hongbao-styles")){let s=document.createElement("style");s.id="hongbao-styles",s.textContent=`
    ...
    `,document.head.appendChild(s)}let t=e.querySelector(".hongbao-particles"),n=["#ffc107","#ff5252","#ff9800","#ffeb3b","#e53935"];for(let s=0;s<20;s++){let o=document.createElement("div");o.className="hongbao-particle",o.style.background=n[s%n.length],o.style.left="50%",o.style.top="50%",o.style.setProperty("--px",`${(Math.random()-.5)*300}px`),o.style.setProperty("--py",`${(Math.random()-.5)*300}px`),o.style.animationDelay=`${.3+Math.random()*.5}s`,t.appendChild(o)}document.body.appendChild(e);let l=()=>{clearTimeout(i),e.style.opacity="0",e.style.transition="opacity 0.3s",setTimeout(()=>e.remove(),300)};e.addEventListener("click",l);let i=setTimeout(l,3e3)}function $(e,t){let{worldId:n,levelIndex:l,score:i,total:s,gameType:o}=t,a=Math.round(i/Math.max(1,s)*100),r=a>=100?3:a>=70?2:a>=40?1:0,c=a>=100,d=a>=40;d&&y.completeLevel(n,l,a);let p=[];function f(g,b){if(b&&y.addBadge(g)){let h=j.find(u=>u.id===g);h&&p.push(h)}}f("first-step",y.getTotalLevelsCompleted()>=1),f("quick-learner",c&&l===0),f("command-king",y.getWorldCompletion(2)>=100),f("prompt-sage",c&&o==="prompt-builder"),f("interview-ready",o==="boss-battle"&&d),f("completionist",[1,2,3,4].every(g=>y.getWorldCompletion(g)>=100)),f("speed-demon",c&&o==="trivia"),f("practice-master",y.getStreak().current>=7),f("unstoppable",y.getStreak().current>=21);let x=y.getWorldCompletion(n)>=100,m="correctAnswer";c?m="perfectScore":d?x&&(m="worldComplete"):m="retry",e.innerHTML=`
    ${w("\u7ED3\u679C Results",!1)}
    <div class="screen" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-lg);padding-top:calc(var(--header-height) + var(--space-xl));">
      ${S(m)}
      <div style="text-align:center;">
        <div class="stars" style="justify-content:center;font-size:var(--text-3xl);margin-bottom:var(--space-md);">
          ${[1,2,3].map(g=>`<span class="star ${g<=r?"earned":""}" style="animation:${g<=r?`bounceIn 0.3s ${g*.2}s both`:"none"}">\u2605</span>`).join("")}
        </div>
        <div style="font-size:var(--text-4xl);font-weight:700;color:${c?"var(--gold)":"var(--teal)"};">${a}%</div>
        <p style="color:var(--text-secondary);margin-top:var(--space-xs);">${i}/${s} \u6B63\u786E</p>
        <p style="color:var(--text-secondary);font-size:var(--text-sm);margin-top:var(--space-xs);">+${a} XP</p>
      </div>
  ...
  `,p.forEach((g,b)=>{setTimeout(()=>ge(g),(b+1)*800)}),c?(setTimeout(()=>ve(),500),C("perfect")):d?C("levelUp"):C("wrong"),e.querySelector("#next-level")?.addEventListener("click",()=>{let g=l+1,b=y.getWorldLevelCount(n);g<b?_.navigate(`/world/${n}`):n<4?_.navigate(`/world/${n+1}`):_.navigate("/")}),e.querySelector("#retry")?.addEventListener("click",()=>{_.navigate(`/game/${o}/${n}/${l}`)}),e.querySelector("#go-home")?.addEventListener("click",()=>_.navigate("/"))}function fe(e,t,n){let i=E.filter(c=>c.world===t);i.length<10&&(i=[...E]);let s=z(i).slice(0,10),o=0,a=0;function r(){if(o>=s.length){$(e,{worldId:t,levelIndex:n,score:a,total:10,gameType:"flash-match"});return}let c=s[o],d=o+1;e.innerHTML=`
          ...
          <div class="flip-card" id="flashcard">
            <div class="flip-card-inner">
              <div class="flip-card-front">
                <div style="font-size:var(--text-2xl);font-weight:700;">${c.en}</div>
              </div>
              <div class="flip-card-back">
                <div style="font-size:var(--text-xl);font-weight:700;color:var(--teal);">${c.zh}</div>
                <div style="font-size:var(--text-sm);color:var(--text-secondary);margin-top:var(--space-xs);">${c.pinyin}</div>
                <div style="font-size:var(--text-sm);color:var(--text-secondary);margin-top:var(--space-sm);line-height:1.5;text-align:center;">${c.explanation}</div>
              </div>
            </div>
          </div>
        </div>
    ...
    `;let p=e.querySelector("#flashcard"),f=e.querySelector("#action-btns");p.addEventListener("click",()=>{p.classList.contains("flipped")||(p.classList.add("flipped"),C("cardFlip"),f.style.display="flex")}),e.querySelector("#btn-know")?.addEventListener("click",()=>{a++,C("correct"),o++,r()}),e.querySelector("#btn-review")?.addEventListener("click",()=>{y.addToReviewQueue({id:c.id,type:"vocab"}),C("wrong"),o++,r()})}r()}function Re(e,t){let n=E.filter(i=>i.world===e);return n.length<4&&(n=[...E]),z(n).slice(0,t).map(i=>{let s=z(E.filter(r=>r.id!==i.id)).slice(0,3),o=z([i,...s]),a=o.findIndex(r=>r.id===i.id);return{question_zh:`\u300C${i.zh}\u300D\u7684\u82F1\u6587\u662F\u4EC0\u4E48\uFF1F`,question_en:`What is "${i.zh}" in English?`,options:o.map(r=>r.en),correctIndex:a,explanation:i.explanation}})}function ye(e,t,n){let s=Re(t,10),o=0,a=0,r=null;function c(){r&&(clearInterval(r),r=null)}function d(){if(c(),o>=s.length){$(e,{worldId:t,levelIndex:n,score:a,total:s.length,gameType:"trivia"});return}let p=s[o],f=o+1,x=["A","B","C","D"];e.innerHTML=`
      ${w("\u77E5\u8BC6\u95EE\u7B54 Trivia",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>${f}/${s.length}</span>
          <span>\u2713 ${a}</span>
        </div>
        <div class="timer-bar">
    ...
    `;let m=15*10,g=e.querySelector("#timer-fill");r=setInterval(()=>{m--;let u=m/(15*10)*100;g.style.width=`${u}%`,u<=20?g.className="timer-bar-fill danger":u<=50&&(g.className="timer-bar-fill warning"),m<=0&&(c(),h())},100),_.setCleanup(()=>c());function b(u,v=""){c();let k=e.querySelector("#feedback");if(k.style.display="block",u)a++,k.innerHTML=R(!0,`<strong>\u6B63\u786E\uFF01 Correct!</strong><br>${p.explanation}`);else{let L=E.find(T=>T.en===p.options[p.correctIndex]);L&&y.addToReviewQueue({id:L.id,type:"vocab"}),k.innerHTML=R(!1,`<strong>${v}\u6B63\u786E\u7B54\u6848: ${p.options[p.correctIndex]}</strong><br>${p.explanation}`)}setTimeout(()=>{o++,d()},2500)}function h(){c(),e.querySelectorAll(".option-btn").forEach((v,k)=>{v.classList.add("disabled"),k===p.correctIndex&&v.classList.add("correct")}),C("wrong"),b(!1,"\u65F6\u95F4\u5230\uFF01 Time's up! ")}P(e,p.correctIndex,()=>b(!0),()=>b(!1))}d()}U();function be(e){return`
  ...
  `}function xe(e){let t=e.querySelector("[data-terminal]");if(!t)return;let n=t.querySelector("[data-terminal-output]"),l=t.querySelector("[data-terminal-input]");if(!n||!l)return;let i={};Promise.resolve().then(()=>(U(),pe)).then(a=>{a.commands&&Array.isArray(a.commands)?a.commands.forEach(r=>{i[r.command.toLowerCase()]={terminalResponse:r.terminalResponse}}):a.commands&&typeof a.commands=="object"&&(i=a.commands)}).catch(()=>{});function s(a,r){if(!n)return;let c=document.createElement("div");c.className=r?"terminal-line terminal-command":"terminal-line terminal-response",r?c.textContent=`$ ${a}`:c.innerHTML=a,n.appendChild(c),n.scrollTop=n.scrollHeight}function o(a){let r=a.trim().toLowerCase();if(s(a,!0),r==="")return;let c=Object.keys(i).find(d=>r===d.toLowerCase()||r.startsWith(d.toLowerCase()));if(c)s(i[c].terminalResponse);else if(r==="/help"||r==="help"){let d=Object.keys(i).map(p=>`  ${p}`).join("<br>");s(`\u53EF\u7528\u547D\u4EE4 / Available commands:<br>${d||"  (loading...)"}`)}else s("\u7801\u5C0F\u7801\u8BF4\uFF1A\u8FD9\u4E2A\u547D\u4EE4\u6211\u8FD8\u4E0D\u8BA4\u8BC6\u54E6\uFF01\u8BD5\u8BD5 /help\uFF1F")}l.addEventListener("keydown",a=>{if(a.key==="Enter"){let r=l.value;l.value="",o(r)}}),t.addEventListener("click",()=>{l.focus()})}function Ce(e,t,n){let i=z([...H]).slice(0,8),s=0,o=0;function a(){if(s>=i.length){$(e,{worldId:t,levelIndex:n,score:o,total:8,gameType:"charades"});return}let r=i[s],c=s+1,d=z([r.command+" \u2014 "+r.zhName,...r.wrongChoices]),p=r.command+" \u2014 "+r.zhName,f=d.indexOf(p),x=["A","B","C","D"];e.innerHTML=`
      ${w("\u573A\u666F\u731C\u8C1C Charades",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>${c}/8</span>
        ...
        <div class="progress-bar">
          <div class="progress-bar-fill" style="width:${c/8*100}%"></div>
        </div>
        <div class="game-question">
          ${r.scenario}
        </div>
    ...
    `;let m=e.querySelector("#feedback-area");function g(b){m.style.display="block",b?(o++,m.innerHTML=`
          ${R(!0,`<strong>\u6B63\u786E\uFF01 Correct!</strong><br>${r.zhDescription}`)}
        ...
        `,e.querySelector("#try-terminal")?.addEventListener("click",()=>{let h=e.querySelector("#terminal-sandbox");h.style.display="block",h.innerHTML=be(r.command),xe(h),e.querySelector("#try-terminal").style.display="none"})):(y.addToReviewQueue({id:r.id,type:"command"}),m.innerHTML=`
          ${R(!1,`<strong>\u6B63\u786E\u7B54\u6848: ${r.command}</strong><br>${r.zhDescription}`)}
          <button class="btn btn-primary btn-block" id="next-btn" style="margin-top:var(--space-sm);">\u4E0B\u4E00\u9898 Next \u2192</button>
        `),e.querySelector("#next-btn")?.addEventListener("click",()=>{s++,a()})}P(e,f,()=>g(!0),()=>g(!1))}a()}var Pe=[{task_zh:"\u8C03\u8BD5\u4E00\u4E2A\u5931\u8D25\u7684\u6D4B\u8BD5",task_en:"Debug a failing test",steps:["\u8BFB\u53D6\u9519\u8BEF\u4FE1\u606F Read error","\u5206\u6790\u539F\u56E0 Analyze cause","\u4FEE\u590D\u4EE3\u7801 Fix code","\u8FD0\u884C\u6D4B\u8BD5 Run tests","\u63D0\u4EA4\u4FEE\u590D Commit fix"]},{task_zh:"\u6DFB\u52A0\u4E00\u4E2A\u65B0\u529F\u80FD",task_en:"Add a new feature",steps:["\u521B\u5EFA\u5206\u652F Create branch","\u7F16\u5199\u4EE3\u7801 Write code","\u6DFB\u52A0\u6D4B\u8BD5 Add tests","\u4EE3\u7801\u5BA1\u67E5 Code review","\u5408\u5E76\u5206\u652F Merge branch"]},{task_zh:"\u90E8\u7F72\u9879\u76EE\u5230\u751F\u4EA7\u73AF\u5883",task_en:"Deploy to production",steps:["\u8FD0\u884C\u6D4B\u8BD5 Run tests","\u6784\u5EFA\u9879\u76EE Build project","\u68C0\u67E5\u914D\u7F6E Check config","\u90E8\u7F72\u4E0A\u7EBF Deploy","\u9A8C\u8BC1\u8FD0\u884C Verify live"]},{task_zh:"\u4FEE\u590D\u4E00\u4E2A\u7D27\u6025 Bug",task_en:"Fix a critical bug",steps:["\u590D\u73B0\u95EE\u9898 Reproduce bug","\u5B9A\u4F4D\u4EE3\u7801 Locate code","\u7F16\u5199\u4FEE\u590D Write fix","\u6D4B\u8BD5\u4FEE\u590D Test fix","\u70ED\u4FEE\u590D\u90E8\u7F72 Hotfix deploy"]},{task_zh:"\u91CD\u6784\u4E00\u6BB5\u65E7\u4EE3\u7801",task_en:"Refactor legacy code",steps:["\u7406\u89E3\u73B0\u6709\u903B\u8F91 Understand logic","\u7F16\u5199\u6D4B\u8BD5 Write tests","\u91CD\u6784\u4EE3\u7801 Refactor","\u8FD0\u884C\u6D4B\u8BD5 Run tests","\u63D0\u4EA4\u66F4\u6539 Commit changes"]}];function we(e,t,n){let i=z([...Pe]).slice(0,5),s=0,o=0;function a(){if(s>=i.length){$(e,{worldId:t,levelIndex:n,score:o,total:5,gameType:"drag-drop"});return}let r=i[s],c=s+1,d=z([...r.steps]),p=new Array(r.steps.length).fill(null);f();function f(){let x=d.filter(m=>!p.includes(m));e.innerHTML=`
        ${w("\u6D41\u7A0B\u6392\u5E8F Drag & Drop",!0)}
        <div class="game-screen">
          ${G(c,5,o)}
          <div class="game-question">
            ${r.task_zh}
            <div class="game-question-sub">${r.task_en}</div>
          </div>
      ...
      `,e.querySelectorAll(".prompt-block").forEach(m=>{m.addEventListener("click",()=>{let g=m.dataset.step||"",b=p.indexOf(null);b!==-1&&(p[b]=g,C("keystroke"),f())})}),e.querySelectorAll(".drop-zone.filled").forEach(m=>{m.addEventListener("click",()=>{let g=parseInt(m.dataset.slot||"-1");g>=0&&p[g]&&(p[g]=null,C("keystroke"),f())})}),e.querySelector("#btn-reset")?.addEventListener("click",()=>{p.fill(null),f()}),e.querySelector("#btn-submit")?.addEventListener("click",()=>{let m=p.every((h,u)=>h===r.steps[u]),g=e.querySelector("#feedback");g.style.display="block",m?(o++,C("correct"),g.innerHTML=R(!0,"<strong>\u6B63\u786E\uFF01 Correct!</strong><br>\u5B8C\u7F8E\u7684\u6D41\u7A0B\u987A\u5E8F\uFF01")):(C("wrong"),g.innerHTML=R(!1,`<strong>\u6B63\u786E\u987A\u5E8F Correct order:</strong><br>${r.steps.map((h,u)=>`${u+1}. ${h}`).join("<br>")}`));let b=e.querySelector("#footer");b.innerHTML='<button class="btn btn-primary btn-block" id="next-btn">\u4E0B\u4E00\u9898 Next \u2192</button>',e.querySelector("#next-btn")?.addEventListener("click",()=>{s++,a()})})}}a()}U();function ke(e,t,n){let i=z([...H]).slice(0,8),s=z([...i.map(x=>({id:x.id+"-en",pairId:x.id,text:x.command,type:"en"})),...i.map(x=>({id:x.id+"-zh",pairId:x.id,text:x.zhName,type:"zh"}))]),o=[],a=[],r=0,c=Date.now(),d=!1;function p(){let x=Math.floor((Date.now()-c)/1e3),m=Math.floor(x/60),g=x%60;e.innerHTML=`
      ${w("\u8BB0\u5FC6\u914D\u5BF9 Memory Match",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>\u6B65\u6570 Moves: ${r}</span>
          <span>\u914D\u5BF9 Pairs: ${a.length}/8</span>
          <span id="timer">${m}:${g.toString().padStart(2,"0")}</span>
        </div>
        <div class="progress-bar">
          <div class="progress-bar-fill" style="width:${a.length/8*100}%"></div>
        </div>
        <div class="game-body" style="justify-content:center;">
          <div class="memory-grid">
            ${s.map((b,h)=>{let u=o.includes(h),v=a.includes(b.pairId),k=["memory-card"];return(u||v)&&k.push("flipped"),v&&k.push("matched"),`
                <div class="${k.join(" ")}" data-index="${h}">
    ...
    `,e.querySelectorAll(".memory-card").forEach(b=>{b.addEventListener("click",()=>{if(d)return;let h=parseInt(b.dataset.index||"-1");if(!(h<0||o.includes(h)||a.includes(s[h].pairId))&&(o.push(h),b.classList.add("flipped"),C("cardFlip"),o.length===2)){r++,d=!0;let[u,v]=o,k=s[u],L=s[v];if(k.pairId===L.pairId&&k.type!==L.type){if(a.push(k.pairId),C("correct"),o=[],d=!1,e.querySelectorAll(`.memory-card[data-index="${u}"], .memory-card[data-index="${v}"]`).forEach(T=>T.classList.add("matched")),a.length===8){let T=Math.floor((Date.now()-c)/1e3),M=Math.max(20,100-(r-8)*5);setTimeout(()=>{$(e,{worldId:t,levelIndex:n,score:M,total:100,gameType:"memory-match"})},800)}}else setTimeout(()=>{o=[],d=!1,p()},800)}})})}let f=setInterval(()=>{let x=e.querySelector("#timer");if(!x){clearInterval(f);return}let m=Math.floor((Date.now()-c)/1e3),g=Math.floor(m/60),b=m%60;x.textContent=`${g}:${b.toString().padStart(2,"0")}`},1e3);_.setCleanup(()=>clearInterval(f)),p()}var W=[{id:"pe1",task_zh:"\u7ED9\u9879\u76EE\u6DFB\u52A0\u7528\u6237\u767B\u5F55\u529F\u80FD",badPrompt:"\u5E2E\u6211\u52A0\u4E2A\u767B\u5F55",goodPrompt:"\u5728 src/auth.ts \u4E2D\u6DFB\u52A0\u4E00\u4E2A login \u51FD\u6570\uFF0C\u63A5\u6536 email \u548C password \u53C2\u6570\uFF0C\u4F7F\u7528 bcrypt \u9A8C\u8BC1\u5BC6\u7801\uFF0C\u8FD4\u56DE JWT token\u3002\u53C2\u8003\u9879\u76EE\u4E2D\u5DF2\u6709\u7684 register \u51FD\u6570\u7684\u98CE\u683C\u3002",rating:{clarity:5,specificity:5,context:4,tone:5},explanation_zh:"\u597D\u7684\u63D0\u793A\u8BCD\u6307\u5B9A\u4E86\u6587\u4EF6\u4F4D\u7F6E\u3001\u51FD\u6570\u540D\u3001\u53C2\u6570\u3001\u6280\u672F\u5B9E\u73B0\u65B9\u6848\uFF0C\u8FD8\u63D0\u5230\u4E86\u53C2\u8003\u5DF2\u6709\u4EE3\u7801\u7684\u98CE\u683C\u3002Claude Code \u80FD\u7CBE\u786E\u6267\u884C\u3002"},{id:"pe2",task_zh:"\u4FEE\u590D\u4E00\u4E2A\u62A5\u9519",badPrompt:"\u4EE3\u7801\u6709 bug \u5E2E\u6211\u4FEE",goodPrompt:"\u8FD0\u884C npm test \u65F6\u62A5\u9519 TypeError: Cannot read property 'name' of undefined\uFF0C\u51FA\u73B0\u5728 src/utils.ts \u7B2C 42 \u884C\u3002\u8BF7\u5206\u6790\u539F\u56E0\u5E76\u4FEE\u590D\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u628A\u5B8C\u6574\u7684\u62A5\u9519\u4FE1\u606F\u3001\u6587\u4EF6\u4F4D\u7F6E\u548C\u884C\u53F7\u90FD\u7ED9\u4E86 Claude Code\uFF0C\u5B83\u4E0D\u9700\u8981\u731C\u6D4B\u5C31\u80FD\u76F4\u63A5\u5B9A\u4F4D\u95EE\u9898\u3002"},{id:"pe3",task_zh:"\u91CD\u6784\u4E00\u4E2A\u590D\u6742\u51FD\u6570",badPrompt:"\u8FD9\u4E2A\u51FD\u6570\u592A\u4E71\u4E86\uFF0C\u6539\u4E00\u4E0B",goodPrompt:"\u91CD\u6784 src/parser.ts \u4E2D\u7684 parseConfig \u51FD\u6570\u3002\u5F53\u524D\u51FD\u6570\u6709 120 \u884C\uFF0C\u8BF7\u62C6\u5206\u6210\u66F4\u5C0F\u7684\u8F85\u52A9\u51FD\u6570\uFF0C\u6BCF\u4E2A\u4E0D\u8D85\u8FC7 30 \u884C\u3002\u4FDD\u6301\u6240\u6709\u73B0\u6709\u6D4B\u8BD5\u901A\u8FC7\u3002",rating:{clarity:5,specificity:4,context:4,tone:5},explanation_zh:"\u660E\u786E\u4E86\u91CD\u6784\u76EE\u6807\uFF08\u62C6\u5206\u51FD\u6570\uFF09\u3001\u5177\u4F53\u6807\u51C6\uFF08\u6BCF\u4E2A\u4E0D\u8D85\u8FC7 30 \u884C\uFF09\u548C\u7EA6\u675F\u6761\u4EF6\uFF08\u6D4B\u8BD5\u8981\u901A\u8FC7\uFF09\uFF0CClaude Code \u6709\u6E05\u6670\u7684\u65B9\u5411\u3002"},{id:"pe4",task_zh:"\u4E3A\u51FD\u6570\u6DFB\u52A0 TypeScript \u7C7B\u578B",badPrompt:"\u52A0\u7C7B\u578B",goodPrompt:"\u7ED9 src/api.ts \u4E2D\u6240\u6709\u5BFC\u51FA\u51FD\u6570\u6DFB\u52A0 TypeScript \u7C7B\u578B\u58F0\u660E\u3002\u53C2\u6570\u548C\u8FD4\u56DE\u503C\u90FD\u8981\u6709\u660E\u786E\u7C7B\u578B\uFF0C\u4E0D\u8981\u7528 any\u3002\u53C2\u8003\u9879\u76EE\u7684 tsconfig.json \u4E2D\u7684 strict \u914D\u7F6E\u3002",rating:{clarity:4,specificity:4,context:4,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u8303\u56F4\uFF08\u6240\u6709\u5BFC\u51FA\u51FD\u6570\uFF09\u3001\u8981\u6C42\uFF08\u4E0D\u7528 any\uFF09\u548C\u53C2\u8003\u6587\u4EF6\uFF08tsconfig.json\uFF09\uFF0CClaude Code \u80FD\u6309\u89C4\u8303\u6267\u884C\u3002"},{id:"pe5",task_zh:"\u521B\u5EFA\u4E00\u4E2A\u65B0\u7684 API \u7AEF\u70B9",badPrompt:"\u5199\u4E2A API",goodPrompt:"\u5728 src/routes/users.ts \u4E2D\u65B0\u589E\u4E00\u4E2A GET /api/users/:id \u7AEF\u70B9\u3002\u8FD4\u56DE\u7528\u6237\u4FE1\u606F\uFF08name, email, createdAt\uFF09\uFF0C\u5982\u679C\u7528\u6237\u4E0D\u5B58\u5728\u8FD4\u56DE 404\u3002\u4F7F\u7528\u9879\u76EE\u4E2D\u5DF2\u6709\u7684 db.query \u65B9\u6CD5\u67E5\u8BE2\u6570\u636E\u5E93\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u5B8C\u7F8E\u7684\u63D0\u793A\u8BCD\uFF1A\u6307\u5B9A\u4E86\u6587\u4EF6\u3001\u8DEF\u5F84\u3001HTTP \u65B9\u6CD5\u3001\u8FD4\u56DE\u5B57\u6BB5\u3001\u9519\u8BEF\u5904\u7406\u548C\u6570\u636E\u5E93\u65B9\u6CD5\u3002Claude Code \u51E0\u4E4E\u4E0D\u9700\u8981\u989D\u5916\u95EE\u4F60\u3002"},{id:"pe6",task_zh:"\u4F18\u5316\u9875\u9762\u52A0\u8F7D\u901F\u5EA6",badPrompt:"\u7F51\u7AD9\u592A\u6162\u4E86",goodPrompt:"\u9996\u9875\u52A0\u8F7D\u9700\u8981 5 \u79D2\uFF0C\u4E3B\u8981\u74F6\u9888\u662F src/components/Dashboard.tsx \u4E2D\u4E00\u6B21\u6027\u52A0\u8F7D\u4E86\u6240\u6709\u6570\u636E\u3002\u8BF7\u6539\u4E3A\u61D2\u52A0\u8F7D\uFF1A\u5148\u52A0\u8F7D\u9996\u5C4F\u6570\u636E\uFF0C\u6EDA\u52A8\u65F6\u518D\u52A0\u8F7D\u66F4\u591A\u3002\u4F7F\u7528 Intersection Observer API\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u63D0\u4F9B\u4E86\u6027\u80FD\u6307\u6807\uFF085 \u79D2\uFF09\u3001\u95EE\u9898\u5B9A\u4F4D\uFF08Dashboard.tsx\uFF09\u3001\u89E3\u51B3\u65B9\u6848\uFF08\u61D2\u52A0\u8F7D\uFF09\u548C\u6280\u672F\u5B9E\u73B0\uFF08Intersection Observer\uFF09\uFF0C\u975E\u5E38\u6E05\u6670\u3002"},{id:"pe7",task_zh:"\u5199\u5355\u5143\u6D4B\u8BD5",badPrompt:"\u5199\u6D4B\u8BD5",goodPrompt:"\u4E3A src/utils/formatDate.ts \u4E2D\u7684 formatDate \u51FD\u6570\u5199\u5355\u5143\u6D4B\u8BD5\u3002\u8986\u76D6\u4EE5\u4E0B\u573A\u666F\uFF1A\u6709\u6548\u65E5\u671F\u3001\u65E0\u6548\u8F93\u5165\uFF08null, undefined, \u7A7A\u5B57\u7B26\u4E32\uFF09\u3001\u4E0D\u540C\u65F6\u533A\u3002\u4F7F\u7528\u9879\u76EE\u5DF2\u6709\u7684 vitest \u6846\u67B6\u3002",rating:{clarity:5,specificity:5,context:4,tone:5},explanation_zh:"\u5217\u51FA\u4E86\u5177\u4F53\u7684\u6D4B\u8BD5\u573A\u666F\u548C\u8FB9\u754C\u6761\u4EF6\uFF0C\u6307\u5B9A\u4E86\u6D4B\u8BD5\u6846\u67B6\u3002Claude Code \u80FD\u5199\u51FA\u5168\u9762\u7684\u6D4B\u8BD5\u7528\u4F8B\u3002"},{id:"pe8",task_zh:"\u6DFB\u52A0\u6697\u8272\u4E3B\u9898\u652F\u6301",badPrompt:"\u52A0\u4E2A\u6697\u8272\u6A21\u5F0F",goodPrompt:"\u4E3A\u5E94\u7528\u6DFB\u52A0\u6697\u8272\u4E3B\u9898\u5207\u6362\u3002\u5728 src/styles/globals.css \u4E2D\u7528 CSS \u53D8\u91CF\u5B9A\u4E49\u989C\u8272\uFF0C\u5728 src/components/Header.tsx \u6DFB\u52A0\u5207\u6362\u6309\u94AE\uFF0C\u7528 localStorage \u8BB0\u4F4F\u7528\u6237\u504F\u597D\u3002\u5F53\u524D\u6D45\u8272\u4E3B\u9898\u8272\u53F7\uFF1A\u80CC\u666F #FFFFFF\uFF0C\u6587\u5B57 #1A1A1A\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u5B9E\u73B0\u65B9\u6848\uFF08CSS \u53D8\u91CF\uFF09\u3001\u4FEE\u6539\u6587\u4EF6\u3001\u6301\u4E45\u5316\u65B9\u5F0F\uFF08localStorage\uFF09\u548C\u73B0\u6709\u914D\u8272\uFF0CClaude Code \u6709\u5B8C\u6574\u4FE1\u606F\u6765\u5B9E\u73B0\u3002"},{id:"pe9",task_zh:"\u4EE3\u7801\u5BA1\u67E5",badPrompt:"\u770B\u770B\u6709\u6CA1\u6709\u95EE\u9898",goodPrompt:"\u5BA1\u67E5 src/services/payment.ts \u4E2D\u7684 processPayment \u51FD\u6570\u3002\u91CD\u70B9\u68C0\u67E5\uFF1A1) \u9519\u8BEF\u5904\u7406\u662F\u5426\u5B8C\u5584 2) \u662F\u5426\u6709\u5B89\u5168\u6F0F\u6D1E 3) \u662F\u5426\u6B63\u786E\u5904\u7406\u4E86\u5E76\u53D1\u8BF7\u6C42\u3002",rating:{clarity:5,specificity:4,context:3,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u5BA1\u67E5\u6587\u4EF6\u548C\u4E09\u4E2A\u91CD\u70B9\u5173\u6CE8\u65B9\u5411\uFF0CClaude Code \u53EF\u4EE5\u6709\u9488\u5BF9\u6027\u5730\u8FDB\u884C\u4EE3\u7801\u5BA1\u67E5\u3002"},{id:"pe10",task_zh:"\u914D\u7F6E CI/CD \u6D41\u6C34\u7EBF",badPrompt:"\u5E2E\u6211\u81EA\u52A8\u5316\u90E8\u7F72",goodPrompt:"\u521B\u5EFA .github/workflows/deploy.yml \u914D\u7F6E GitHub Actions\uFF1Apush \u5230 main \u5206\u652F\u65F6\u81EA\u52A8\u8FD0\u884C npm test\uFF0C\u6D4B\u8BD5\u901A\u8FC7\u540E\u7528 wrangler \u90E8\u7F72\u5230 Cloudflare Pages\u3002\u9879\u76EE\u540D\u662F my-app\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u5305\u542B\u4E86\u6587\u4EF6\u8DEF\u5F84\u3001\u89E6\u53D1\u6761\u4EF6\u3001\u6B65\u9AA4\uFF08\u6D4B\u8BD5\u2192\u90E8\u7F72\uFF09\u3001\u5DE5\u5177\uFF08wrangler\uFF09\u548C\u9879\u76EE\u540D\uFF0CClaude Code \u80FD\u751F\u6210\u5B8C\u6574\u7684 CI/CD \u914D\u7F6E\u3002"},{id:"pe11",task_zh:"\u89E3\u91CA\u4E00\u6BB5\u4EE3\u7801",badPrompt:"\u8FD9\u662F\u4EC0\u4E48",goodPrompt:"\u8BF7\u9010\u884C\u89E3\u91CA src/middleware/auth.ts \u4E2D\u7684 verifyToken \u4E2D\u95F4\u4EF6\u51FD\u6570\u3002\u6211\u662F\u65B0\u624B\uFF0C\u8BF7\u7528\u7B80\u5355\u7684\u8BED\u8A00\uFF0C\u5E76\u89E3\u91CA\u4E3A\u4EC0\u4E48\u6BCF\u4E00\u6B65\u662F\u5FC5\u8981\u7684\u3002",rating:{clarity:5,specificity:4,context:4,tone:5},explanation_zh:"\u8BF4\u660E\u4E86\u8981\u89E3\u91CA\u7684\u5177\u4F53\u51FD\u6570\u3001\u89E3\u91CA\u65B9\u5F0F\uFF08\u9010\u884C\uFF09\u3001\u4F60\u7684\u6C34\u5E73\uFF08\u65B0\u624B\uFF09\u548C\u671F\u671B\uFF08\u7B80\u5355\u8BED\u8A00\uFF09\uFF0CClaude Code \u80FD\u7ED9\u51FA\u5408\u9002\u7684\u89E3\u91CA\u3002"},{id:"pe12",task_zh:"\u8FC1\u79FB\u6570\u636E\u5E93",badPrompt:"\u6362\u4E2A\u6570\u636E\u5E93",goodPrompt:"\u628A\u9879\u76EE\u4ECE SQLite \u8FC1\u79FB\u5230 PostgreSQL\u3002\u9700\u8981\u4FEE\u6539\u7684\u6587\u4EF6\uFF1Asrc/db/connection.ts\uFF08\u8FDE\u63A5\u914D\u7F6E\uFF09\u3001src/db/queries.ts\uFF08SQL \u8BED\u6CD5\u5DEE\u5F02\uFF09\u3002\u4FDD\u6301\u6240\u6709\u73B0\u6709\u7684 API \u63A5\u53E3\u4E0D\u53D8\u3002",rating:{clarity:5,specificity:5,context:4,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u8FC1\u79FB\u65B9\u5411\u3001\u9700\u8981\u4FEE\u6539\u7684\u6587\u4EF6\u53CA\u539F\u56E0\u3001\u7EA6\u675F\u6761\u4EF6\uFF08API \u4E0D\u53D8\uFF09\u3002Claude Code \u53EF\u4EE5\u7CFB\u7EDF\u6027\u5730\u5B8C\u6210\u8FC1\u79FB\u3002"}];function _e(e,t,n){let i=z(W).slice(0,5),s=0,o=0;function a(){let r=i[s],c=r.goodPrompt.split(/\s+/),d=z(c),p=[];e.innerHTML=`
      ...
      <div class="game-screen">
        ...
        <div class="game-question">${r.task_zh}</div>
    ...
    `;let f=e.querySelector("#tray"),x=e.querySelector("#assembly"),m=e.querySelector("#submit-btn"),g=e.querySelector("#assembly-placeholder");function b(){g&&(g.style.display=p.length>0?"none":""),m.disabled=p.length===0}f.addEventListener("click",h=>{let u=h.target.closest(".prompt-block");if(!u||u.classList.contains("placed"))return;C("keystroke"),u.classList.add("placed");let v=u.dataset.word;p.push(v);let k=document.createElement("div");k.className="prompt-block",k.textContent=v,k.dataset.trayIndex=u.dataset.index,x.appendChild(k),k.addEventListener("click",()=>{C("keystroke");let L=p.indexOf(v);L!==-1&&p.splice(L,1),k.remove(),u.classList.remove("placed"),b()}),b()}),m.addEventListener("click",()=>{let h=c,u=0,v=h.length;for(let q=0;q<Math.min(p.length,v);q++)p[q]===h[q]&&u++;let L=u/v>=.8;L?(o++,C("correct")):(C("wrong"),y.addToReviewQueue({id:r.id,type:"prompt"}));let T=r.rating,M=[["\u6E05\u6670\u5EA6 Clarity",T.clarity],["\u5177\u4F53\u6027 Specificity",T.specificity],["\u4E0A\u4E0B\u6587 Context",T.context],["\u8BED\u6C14 Tone",T.tone]];e.innerHTML=`
        ${w("\u63D0\u793A\u8BCD\u62FC\u88C5 Prompt Builder",!0)}
        <div class="game-screen">
          <div class="game-score-bar">
            <span>\u7B2C ${s+1}/5 \u9898</span>
          ...
          <div class="game-question" style="font-size:var(--text-base);">
            ${L?'<span style="color:var(--green);">\u6B63\u786E!</span>':'<span style="color:var(--red);">\u518D\u52A0\u6CB9!</span>'}
          </div>
          <div style="padding:0 var(--space-md);">
            ...
            <div class="editable-prompt" style="border:1px solid var(--green);margin-bottom:var(--space-md);">${r.goodPrompt}</div>
      ...
      `,e.querySelector("#next-btn").addEventListener("click",()=>{s++,s<5?a():$(e,{worldId:t,levelIndex:n,score:o,total:5,gameType:"prompt-builder"})})})}a()}function ze(e,t,n){let i=z(W).slice(0,5),s=0,o=0;function a(){let r=i[s],c=r.badPrompt.split(/\s+/),d=r.goodPrompt.split(/\s+/),p=new Set(c.map(u=>u.toLowerCase())),f=d.filter(u=>!p.has(u.toLowerCase())),x=z(f),m=c.map(u=>({word:u,removed:!1})),g=[];e.innerHTML=`
      ...
      <div class="game-screen">
        ...
        <div class="game-body">
          ...
          <div class="editable-prompt" id="editable">
            ${c.map((u,v)=>`<span class="word-token" data-index="${v}">${u}</span>`).join("")}
          </div>
    ...
    `;let b=e.querySelector("#editable"),h=e.querySelector("#bank");b.addEventListener("click",u=>{let v=u.target.closest(".word-token");if(!v)return;let k=v.dataset.index,L=v.dataset.bank;if(k!==void 0){let T=parseInt(k);m[T].removed=!m[T].removed,v.classList.toggle("removed",m[T].removed),C("keystroke")}else if(L!==void 0){C("keystroke");let T=v.dataset.word,M=g.findIndex(D=>D.word===T);M!==-1&&g.splice(M,1),v.remove();let q=h.querySelector(`[data-bank="${L}"]`);q&&(q.classList.remove("selected"),q.style.display="")}}),h.addEventListener("click",u=>{let v=u.target.closest(".word-token");if(!v||v.classList.contains("selected"))return;C("keystroke");let k=v.dataset.word,L=v.dataset.bank;v.classList.add("selected"),v.style.display="none",g.push({word:k,afterIndex:m.length});let T=document.createElement("span");T.className="word-token selected",T.textContent=k,T.dataset.bank=L,T.dataset.word=k,b.appendChild(T)}),e.querySelector("#submit-btn").addEventListener("click",()=>{let u=[];m.forEach(I=>{I.removed||u.push(I.word)}),g.forEach(I=>u.push(I.word));let v=u.join(" ").toLowerCase(),k=new Set(d.map(I=>I.toLowerCase())),L=new Set(u.map(I=>I.toLowerCase())),T=0;k.forEach(I=>{L.has(I)&&T++});let M=c.filter(I=>!k.has(I.toLowerCase())),q=0;M.forEach(I=>{L.has(I.toLowerCase())&&q++});let ee=Math.max(0,T/k.size-q*.1)>=.5;ee?(o++,C("correct")):(C("wrong"),y.addToReviewQueue({id:r.id,type:"prompt"})),e.innerHTML=`
        ${w("\u63D0\u793A\u8BCD\u4FEE\u590D Prompt Repair",!0)}
        <div class="game-screen">
          <div class="game-score-bar">
            <span>\u7B2C ${s+1}/5 \u9898</span>
          ...
          <div style="padding:0 var(--space-md);">
            ...
            <div class="editable-prompt" style="border:1px solid var(--red);margin-bottom:var(--space-md);opacity:0.7;">${r.badPrompt}</div>
            ...
            <div class="editable-prompt" style="border:1px solid var(--green);margin-bottom:var(--space-md);">${r.goodPrompt}</div>
            <p style="color:var(--text-secondary);font-size:var(--text-sm);line-height:1.6;">${r.explanation_zh}</p>
          </div>
          <div class="game-footer">
            <button class="btn btn-primary btn-block" id="next-btn">${s+1<5?"\u4E0B\u4E00\u9898 Next":"\u67E5\u770B\u7ED3\u679C Results"}</button>
          </div>
        </div>
      `,e.querySelector("#next-btn").addEventListener("click",()=>{s++,s<5?a():$(e,{worldId:t,levelIndex:n,score:o,total:5,gameType:"prompt-repair"})})})}a()}function Le(e,t,n){let i=z(W),s=[];for(;s.length<10;)s.push(...i);let o=s.slice(0,10),a=0,r=0;function c(){let d=o[a],p=Math.random()<.5,f=p?d.goodPrompt:d.badPrompt,x=p?d.badPrompt:d.goodPrompt,m=p?"left":"right";e.innerHTML=`
      ${w("\u63D0\u793A\u8BCD\u5BF9\u51B3 Prompt Duel",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>\u7B2C ${a+1}/10 \u9898</span>
          <span>\u5F97\u5206: ${r}/10</span>
        </div>
        ...
        <div class="game-footer">
          <button class="btn btn-primary btn-block" id="next-btn" style="display:none;">${a+1<10?"\u4E0B\u4E00\u9898 Next":"\u67E5\u770B\u7ED3\u679C Results"}</button>
        </div>
      </div>
    `;let g=e.querySelector("#card-left"),b=e.querySelector("#card-right"),h=e.querySelector("#explanation"),u=e.querySelector("#explanation-text"),v=e.querySelector("#next-btn"),k=!1;function L(T){if(k)return;k=!0,T===m?(r++,C("correct")):(C("wrong"),y.addToReviewQueue({id:d.id,type:"prompt"}));let q=m==="left"?g:b,D=m==="left"?b:g;q.classList.add("correct"),D.classList.add("wrong"),g.style.pointerEvents="none",b.style.pointerEvents="none",u.textContent=d.explanation_zh,h.style.display="",v.style.display=""}g.addEventListener("click",()=>L("left")),b.addEventListener("click",()=>L("right")),v.addEventListener("click",()=>{a++,a<10?c():$(e,{worldId:t,levelIndex:n,score:r,total:10,gameType:"prompt-duel"})})}c()}var De=[{question_zh:"\u4F60\u4F1A\u600E\u6837\u5F00\u59CB\u4E00\u4E2A\u65B0\u9879\u76EE\uFF1F",question_en:"How would you start a new project?",correctCommand:"/init",commandOptions:["/init","/setup","/new","/config"],keywords:["scaffold","CLAUDE.md","initialize"]},{question_zh:"\u4EE3\u7801\u5E93\u592A\u5927\uFF0C\u653E\u4E0D\u8FDB\u4E0A\u4E0B\u6587\u7A97\u53E3\u3002\u4F60\u4F1A\u600E\u4E48\u505A\uFF1F",question_en:"The codebase is too large for context. What do you do?",correctCommand:"/compact",commandOptions:["/compact","/clear","/shrink","/trim"],keywords:["context","compact","window"]},{question_zh:"\u4F60\u9700\u8981\u64A4\u9500\u4E00\u4E2A\u6700\u8FD1\u7684\u6539\u52A8\u3002\u600E\u4E48\u529E\uFF1F",question_en:"You need to undo a recent change. How?",correctCommand:"/rewind",commandOptions:["/rewind","/undo","/rollback","/restore"],keywords:["revert","undo","checkpoint"]},{question_zh:"\u4F60\u60F3\u67E5\u770B API \u7528\u91CF\u3002\u600E\u4E48\u64CD\u4F5C\uFF1F",question_en:"How do you check your API usage?",correctCommand:"/usage",commandOptions:["/usage","/cost","/billing","/stats"],keywords:["token","cost","usage"]},{question_zh:"\u4EE3\u7801\u5BA1\u67E5\u6D41\u7A0B\u662F\u600E\u6837\u7684\uFF1F",question_en:"Code review process?",correctCommand:"/review",commandOptions:["/review","/lint","/check","/audit"],keywords:["review","quality","feedback"]},{question_zh:"\u5982\u4F55\u7B80\u5316\u590D\u6742\u7684\u4EE3\u7801\uFF1F",question_en:"How to simplify complex code?",correctCommand:"/simplify",commandOptions:["/simplify","/explain","/easy","/translate"],keywords:["refactor","simplify","clean"]}];function Te(e,t,n){let s=z(De).slice(0,3),o=0,a=0,r=!0;function c(){e.innerHTML=`
    ...
    `,e.querySelector("#start-btn")?.addEventListener("click",()=>{r=!1,d()})}function d(){if(o>=s.length){$(e,{worldId:t,levelIndex:n,score:a,total:3*100,gameType:"boss-battle"});return}let p=s[o],f=o+1,x=z(p.commandOptions);e.innerHTML=`
      ${w("\u9762\u8BD5\u6A21\u62DF Boss Battle",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>\u573A\u666F ${f}/3</span>
          ...
          `:`
            <div class="game-footer">
              <button class="btn btn-primary btn-block" id="next-step">
                ${s<i.steps.length-1?"\u4E0B\u4E00\u6B65 Next Step":"\u5B8C\u6210 Complete"} \u2192
              </button>
            </div>
          `}
        </div>
      </div>
    `,f){let x=!1,m=e.querySelectorAll("#quiz-options .option-btn");m.forEach(g=>{g.addEventListener("click",()=>{if(x)return;x=!0,o++;let h=parseInt(g.dataset.index||"-1")===d.correctIndex;m.forEach(v=>v.classList.add("disabled")),h?(a++,g.classList.add("correct"),C("correct")):(g.classList.add("wrong"),m.forEach((v,k)=>{k===d.correctIndex&&v.classList.add("correct")}),C("wrong"));let u=e.querySelector("#step-feedback");u.style.display="block",u.style.background=h?"rgba(0, 212, 170, 0.1)":"rgba(255, 107, 107, 0.1)",u.style.border=h?"1px solid var(--green)":"1px solid var(--red)",u.innerHTML=h?"<strong>\u6B63\u786E\uFF01 Correct!</strong>":`<strong>\u9519\u8BEF\u3002\u6B63\u786E\u7B54\u6848: ${(d.options||[])[d.correctIndex||0]}</strong>`,setTimeout(()=>{s++,c()},1800)})})}else e.querySelector("#next-step")?.addEventListener("click",()=>{s++,c()})}e.innerHTML=`
    ${w("\u6BCF\u65E5\u4EFB\u52A1 Daily Mission",!0)}
    <div class="game-screen">
      <div class="game-body" style="align-items:center;justify-content:center;flex:1;">
        ${S("dailyMission")}
        <div style="text-align:center;margin-top:var(--space-lg);">
          ...
          <p style="color:var(--text-secondary);margin-top:var(--space-md);font-size:var(--text-sm);">
            ${i.steps.length} \u4E2A\u6B65\u9AA4 \xB7 ${r} \u9053\u6D4B\u9A8C\u9898
            <br>${i.steps.length} steps \xB7 ${r} quiz questions
          </p>
        </div>
      </div>
      <div class="game-footer">
  ...
  `,e.querySelector("#start-mission")?.addEventListener("click",()=>{c()})}function X(){let e=[];for(let t of[1,2,3,4])Z[t]&&e.push(...Z[t]);return e}function He(e,t){return btoa(JSON.stringify({q:e,s:t}))}function Oe(e){try{let t=e.startsWith("#peer=")?e.slice(6):null;if(!t)return null;let n=JSON.parse(atob(t));return!Array.isArray(n.q)||typeof n.s!="number"||!isFinite(n.s)||n.q.length>20?null:{questionIds:n.q.filter(l=>typeof l=="string"),peerScore:Math.min(Math.max(0,Math.floor(n.s)),n.q.length)}}catch{return null}}function Se(e,t,n){let i=Oe(window.location.hash),s;if(i&&i.questionIds.length>0){let d=X();s=i.questionIds.map(p=>d.find(f=>f.id===p)).filter(p=>!!p),s.length===0&&(s=z(X()).slice(0,5))}else s=z(X()).slice(0,5);let o=0,a=0;function r(){if(o>=s.length){c();return}let d=s[o],p=o+1,f=["A","B","C","D"];e.innerHTML=`
    ...
    `;let x=m=>{let g=e.querySelector("#feedback");g.style.display="block",g.innerHTML=m?R(!0,`<strong>\u6B63\u786E\uFF01 Correct!</strong><br>${d.explanation_zh}`):R(!1,`<strong>\u6B63\u786E\u7B54\u6848: ${d.options[d.correctIndex]}</strong><br>${d.explanation_zh}`),setTimeout(()=>{o++,r()},2e3)};P(e,d.correctIndex,()=>{a++,x(!0)},()=>{x(!1)})}function c(){let d=s.map(b=>b.id),p=He(d,a),x=`${window.location.origin+window.location.pathname}#peer=${p}`,m=Math.round(a/s.length*100),g="";if(i){let b=Math.round(i.peerScore/s.length*100),h=m-b,u="";h>0?u=`\u4F60\u8D62\u4E86\uFF01 You won by ${h}%!`:h<0?u=`\u670B\u53CB\u8D62\u4E86\uFF01 Your friend won by ${Math.abs(h)}%!`:u="\u5E73\u5C40\uFF01 It's a tie!",g=`
      ...
      <div class="game-screen">
        <div class="game-body" style="align-items:center;">
          ...
          <div style="text-align:center;margin-top:var(--space-md);">
            <div style="font-size:var(--text-3xl);font-weight:700;color:var(--teal);">${a}/${s.length}</div>
    ...
    `,e.querySelector("#copy-link")?.addEventListener("click",()=>{let b=e.querySelector("#share-link"),h=e.querySelector("#copy-feedback");navigator.clipboard.writeText(b.value).then(()=>{y.addBadge("sharing-caring"),h.style.display="block",h.textContent="\u5DF2\u590D\u5236\uFF01 Copied!",C("correct"),setTimeout(()=>{h.style.display="none"},2e3)}).catch(()=>{b.select(),h.style.display="block",h.textContent="\u8BF7\u624B\u52A8\u590D\u5236 Please copy manually (Ctrl+C)",h.style.color="var(--gold)"})}),e.querySelector("#view-results")?.addEventListener("click",()=>{$(e,{worldId:t,levelIndex:n,score:a,total:s.length,gameType:"peer-challenge"})})}e.innerHTML=`
    ${w("\u540C\u4F34\u6311\u6218 Peer Challenge",!0)}
    <div class="game-screen">
      <div class="game-body" style="align-items:center;justify-content:center;flex:1;">
          ...
          ${i?`
            <div class="card" style="margin-top:var(--space-md);padding:var(--space-sm);">
              <span style="font-size:var(--text-sm);color:var(--gold);">
                \u670B\u53CB\u7684\u6210\u7EE9: ${i.peerScore}/${s.length} \xB7 Friend's score: ${i.peerScore}/${s.length}
              </span>
            </div>
          `:""}
        </div>
  ...
  `,e.querySelector("#start-challenge")?.addEventListener("click",()=>{r()})}var O=document.getElementById("app"),We={"flash-match":fe,trivia:ye,charades:Ce,"drag-drop":we,"memory-match":ke,"prompt-builder":_e,"prompt-repair":ze,"prompt-duel":Le,"boss-battle":Te,"daily-mission":qe,"peer-challenge":Se};_.addRoute("/",()=>{if(!y.isPlacementDone()){_.navigate("/placement");return}y.updateStreak(),re(O)});_.addRoute("/placement",()=>{de(O)});_.addRoute("/world/:id",e=>{let t=parseInt(e.id);t>=1&&t<=4?le(O,t):_.navigate("/")});_.addRoute("/game/:type/:worldId/:levelId",e=>{let t=e.type,n=parseInt(e.worldId),l=parseInt(e.levelId),i=We[t];if(i){if(!y.isLevelUnlocked(n,l)){_.navigate(`/world/${n}`);return}i(O,n,l)}else _.navigate("/")});_.addRoute("/glossary",()=>{ce(O)});_.addRoute("/review",()=>{me(O)});_.addRoute("/profile",()=>{he(O)});_.start();
